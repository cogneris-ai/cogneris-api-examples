...
/**
 * Gets or Sets DocumentJobStatus
 */
public enum DocumentJobStatus {
  ...
  DocumentJobStatus(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static DocumentJobStatus fromValue(String value) {
    for (DocumentJobStatus b : DocumentJobStatus.values()) {
