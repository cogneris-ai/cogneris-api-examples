 ...
 */
@JsonPropertyOrder({
  FaceMatch.JSON_PROPERTY_SOURCE_DOCUMENT_ID,
  FaceMatch.JSON_PROPERTY_SELFIE_DOCUMENT_ID,
  FaceMatch.JSON_PROPERTY_SCORE,
  FaceMatch.JSON_PROPERTY_MATCHED,
  FaceMatch.JSON_PROPERTY_TOO_MANY_FACES
})
...
public class FaceMatch {
  ...
  public static final String JSON_PROPERTY_SELFIE_DOCUMENT_ID = "selfieDocumentId";
  @javax.annotation.Nullable
  private UUID selfieDocumentId;
  ...
  public static final String JSON_PROPERTY_TOO_MANY_FACES = "tooManyFaces";
  @javax.annotation.Nullable
  private Boolean tooManyFaces;

  public FaceMatch() {
  }

  public FaceMatch sourceDocumentId(@javax.annotation.Nullable UUID sourceDocumentId) {
  ...
  public FaceMatch selfieDocumentId(@javax.annotation.Nullable UUID selfieDocumentId) {
    this.selfieDocumentId = selfieDocumentId;
    return this;
  }

  /**
   * Get selfieDocumentId
   * @return selfieDocumentId
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_SELFIE_DOCUMENT_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public UUID getSelfieDocumentId() {
    return selfieDocumentId;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_SELFIE_DOCUMENT_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSelfieDocumentId(@javax.annotation.Nullable UUID selfieDocumentId) {
    this.selfieDocumentId = selfieDocumentId;
  }


  public FaceMatch score(@javax.annotation.Nullable BigDecimal score) {
    this.score = score;
    return this;
  }
  ...
  public FaceMatch matched(@javax.annotation.Nullable Boolean matched) {
  ...
  public FaceMatch tooManyFaces(@javax.annotation.Nullable Boolean tooManyFaces) {
    this.tooManyFaces = tooManyFaces;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_TOO_MANY_FACES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public Boolean getTooManyFaces() {
    return tooManyFaces;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_TOO_MANY_FACES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTooManyFaces(@javax.annotation.Nullable Boolean tooManyFaces) {
    this.tooManyFaces = tooManyFaces;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sourceDocumentId, faceMatch.sourceDocumentId) &&
        Objects.equals(this.selfieDocumentId, faceMatch.selfieDocumentId) &&
        Objects.equals(this.score, faceMatch.score) &&
        Objects.equals(this.matched, faceMatch.matched) &&
        Objects.equals(this.tooManyFaces, faceMatch.tooManyFaces);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sourceDocumentId, selfieDocumentId, score, matched, tooManyFaces);
  }
  ...
  public String toString() {
    ...
    sb.append("    selfieDocumentId: ").append(toIndentedString(selfieDocumentId)).append("\n");
    sb.append("    score: ").append(toIndentedString(score)).append("\n");
    sb.append("    matched: ").append(toIndentedString(matched)).append("\n");
    sb.append("    tooManyFaces: ").append(toIndentedString(tooManyFaces)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `selfieDocumentId` to the URL query string
    if (getSelfieDocumentId() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sselfieDocumentId%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSelfieDocumentId()))));
    }
    ...
    // add `tooManyFaces` to the URL query string
    if (getTooManyFaces() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%stooManyFaces%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getTooManyFaces()))));
    }
