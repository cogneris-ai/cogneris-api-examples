...
/**
 * Gets or Sets DocumentJobSubmitStatus
 */
public enum DocumentJobSubmitStatus {
  ...
  DocumentJobSubmitStatus(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static DocumentJobSubmitStatus fromValue(String value) {
    for (DocumentJobSubmitStatus b : DocumentJobSubmitStatus.values()) {
