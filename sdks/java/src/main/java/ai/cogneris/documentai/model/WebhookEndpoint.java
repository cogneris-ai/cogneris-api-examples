 ...
 */
@JsonPropertyOrder({
  WebhookEndpoint.JSON_PROPERTY_ID,
  WebhookEndpoint.JSON_PROPERTY_NAME,
  WebhookEndpoint.JSON_PROPERTY_URL,
  WebhookEndpoint.JSON_PROPERTY_EVENTS,
  WebhookEndpoint.JSON_PROPERTY_HEADERS,
  WebhookEndpoint.JSON_PROPERTY_BODY,
  WebhookEndpoint.JSON_PROPERTY_IS_ACTIVE,
  WebhookEndpoint.JSON_PROPERTY_ENVIRONMENT,
  WebhookEndpoint.JSON_PROPERTY_CREATED_WHEN,
  WebhookEndpoint.JSON_PROPERTY_CHANGED_WHEN,
  WebhookEndpoint.JSON_PROPERTY_SECRET
})
...
public class WebhookEndpoint {
  ...
  public static final String JSON_PROPERTY_CREATED_WHEN = "createdWhen";
  @javax.annotation.Nonnull
  private OffsetDateTime createdWhen;

  public static final String JSON_PROPERTY_CHANGED_WHEN = "changedWhen";
  private JsonNullable<OffsetDateTime> changedWhen = JsonNullable.<OffsetDateTime>undefined();
  ...
  public WebhookEndpoint id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public WebhookEndpoint name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public WebhookEndpoint events(@javax.annotation.Nonnull List<WebhookEvent> events) {
    this.events = events;
    return this;
  }

  public WebhookEndpoint addEventsItem(WebhookEvent eventsItem) {
    if (this.events == null) {
  ...
  public WebhookEndpoint headers(@javax.annotation.Nullable Map<String, String> headers) {
  ...
  public WebhookEndpoint body(@javax.annotation.Nullable String body) {
  ...
  public WebhookEndpoint isActive(@javax.annotation.Nonnull Boolean isActive) {
  ...
  public WebhookEndpoint environment(@javax.annotation.Nullable EnvironmentEnum environment) {
  ...
  public WebhookEndpoint createdWhen(@javax.annotation.Nonnull OffsetDateTime createdWhen) {
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_CREATED_WHEN, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  @JsonProperty(value = JSON_PROPERTY_CREATED_WHEN, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCreatedWhen(@javax.annotation.Nonnull OffsetDateTime createdWhen) {
    this.createdWhen = createdWhen;
  }


  public WebhookEndpoint changedWhen(@javax.annotation.Nullable OffsetDateTime changedWhen) {
    this.changedWhen = JsonNullable.<OffsetDateTime>of(changedWhen);
    return this;
  }
  ...
  @javax.annotation.Nullable
  @JsonIgnore
  public OffsetDateTime getChangedWhen() {
        return changedWhen.orElse(null);
  }

  @JsonProperty(value = JSON_PROPERTY_CHANGED_WHEN, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<OffsetDateTime> getChangedWhen_JsonNullable() {
    return changedWhen;
  }

  @JsonProperty(JSON_PROPERTY_CHANGED_WHEN)
  public void setChangedWhen_JsonNullable(JsonNullable<OffsetDateTime> changedWhen) {
    this.changedWhen = changedWhen;
  }

  public void setChangedWhen(@javax.annotation.Nullable OffsetDateTime changedWhen) {
    this.changedWhen = JsonNullable.<OffsetDateTime>of(changedWhen);
  }


  public WebhookEndpoint secret(@javax.annotation.Nullable String secret) {
  ...
  /**
   * Return true if this WebhookEndpoint object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, webhookEndpoint.id) &&
        Objects.equals(this.name, webhookEndpoint.name) &&
        Objects.equals(this.url, webhookEndpoint.url) &&
        Objects.equals(this.events, webhookEndpoint.events) &&
        equalsNullable(this.headers, webhookEndpoint.headers) &&
        equalsNullable(this.body, webhookEndpoint.body) &&
        Objects.equals(this.isActive, webhookEndpoint.isActive) &&
        Objects.equals(this.environment, webhookEndpoint.environment) &&
        Objects.equals(this.createdWhen, webhookEndpoint.createdWhen) &&
        equalsNullable(this.changedWhen, webhookEndpoint.changedWhen) &&
        equalsNullable(this.secret, webhookEndpoint.secret);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, url, events, hashCodeNullable(headers), hashCodeNullable(body), isActive, environment, createdWhen, hashCodeNullable(changedWhen), hashCodeNullable(secret));
  }
  ...
  public String toString() {
    ...
    sb.append("    changedWhen: ").append(toIndentedString(changedWhen)).append("\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `createdWhen` to the URL query string
    if (getCreatedWhen() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%screatedWhen%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getCreatedWhen()))));
    }

    // add `changedWhen` to the URL query string
    if (getChangedWhen() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%schangedWhen%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getChangedWhen()))));
    }
