 ...
 */
@JsonPropertyOrder({
  WebhookEndpointDeletion.JSON_PROPERTY_DELETED
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.25.0")
public class WebhookEndpointDeletion {
  public static final String JSON_PROPERTY_DELETED = "deleted";
  @javax.annotation.Nonnull
  private Boolean deleted;

  public WebhookEndpointDeletion() {
  }

  public WebhookEndpointDeletion deleted(@javax.annotation.Nonnull Boolean deleted) {
  ...
  /**
   * Return true if this WebhookEndpointDeletion object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    WebhookEndpointDeletion webhookEndpointDeletion = (WebhookEndpointDeletion) o;
    return Objects.equals(this.deleted, webhookEndpointDeletion.deleted);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookEndpointDeletion {\n");
