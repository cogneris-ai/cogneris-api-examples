...
@JsonPropertyOrder({
  ...
  ProblemDetailsErrorsInner.JSON_PROPERTY_DETAILS
})
...
public class ProblemDetailsErrorsInner {
  ...
  public ProblemDetailsErrorsInner details(@javax.annotation.Nullable Map<String, String> details) {
    this.details = JsonNullable.<Map<String, String>>of(details);
    return this;
  }

  public ProblemDetailsErrorsInner putDetailsItem(String key, String detailsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, problemDetailsErrorsInner.code) &&
        ...
        equalsNullable(this.field, problemDetailsErrorsInner.field) &&
        Objects.equals(this.retryable, problemDetailsErrorsInner.retryable) &&
        equalsNullable(this.details, problemDetailsErrorsInner.details);
  }
