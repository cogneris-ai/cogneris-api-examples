...
import ai.cogneris.documentai.model.WebhookEndpointCreated;
 ...
 */
@JsonPropertyOrder({
  WebhookEndpointCreatedEnvelope.JSON_PROPERTY_DATA,
  WebhookEndpointCreatedEnvelope.JSON_PROPERTY_META,
  WebhookEndpointCreatedEnvelope.JSON_PROPERTY_HAS_ERRORS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.25.0")
public class WebhookEndpointCreatedEnvelope {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nonnull
  private WebhookEndpointCreated data;
  ...
  public WebhookEndpointCreatedEnvelope() {
  }

  public WebhookEndpointCreatedEnvelope data(@javax.annotation.Nonnull WebhookEndpointCreated data) {
    this.data = data;
    return this;
  }
  ...
  public WebhookEndpointCreated getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@javax.annotation.Nonnull WebhookEndpointCreated data) {
    this.data = data;
  }


  public WebhookEndpointCreatedEnvelope meta(@javax.annotation.Nonnull ServiceResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public WebhookEndpointCreatedEnvelope hasErrors(@javax.annotation.Nonnull Boolean hasErrors) {
  ...
  /**
   * Return true if this WebhookEndpointCreatedEnvelope object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    WebhookEndpointCreatedEnvelope webhookEndpointCreatedEnvelope = (WebhookEndpointCreatedEnvelope) o;
    return Objects.equals(this.data, webhookEndpointCreatedEnvelope.data) &&
        Objects.equals(this.meta, webhookEndpointCreatedEnvelope.meta) &&
        Objects.equals(this.hasErrors, webhookEndpointCreatedEnvelope.hasErrors);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookEndpointCreatedEnvelope {\n");
