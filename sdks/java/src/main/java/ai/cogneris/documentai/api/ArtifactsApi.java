...
import ai.cogneris.documentai.model.ArtifactUploadEnvelope;
import java.io.File;
...
public class ArtifactsApi {
   ...
   * @param reference An &#x60;artifact://&#x60; reference, or the bucket-qualified form an older job returned. Pass back exactly what you were given.  (required)
   * @return File
   * @throws ApiException if fails to make API call
   */
  public File downloadArtifact(@javax.annotation.Nonnull String reference) throws ApiException {
    return downloadArtifact(reference, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public File downloadArtifact(@javax.annotation.Nonnull String reference, Map<String, String> headers) throws ApiException {
    ApiResponse<File> localVarResponse = downloadArtifactWithHttpInfo(reference, headers);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> downloadArtifactWithHttpInfo(@javax.annotation.Nonnull String reference) throws ApiException {
    return downloadArtifactWithHttpInfo(reference, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> downloadArtifactWithHttpInfo(@javax.annotation.Nonnull String reference, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = downloadArtifactRequestBuilder(reference, headers);
    try {
  ...
  private HttpRequest.Builder downloadArtifactRequestBuilder(@javax.annotation.Nonnull String reference, Map<String, String> headers) throws ApiException {
    // verify the required parameter 'reference' is set
    if (reference == null) {
      throw new ApiException(400, "Missing the required parameter 'reference' when calling downloadArtifact");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/api/v1/artifacts/content";
    ...
    localVarRequestBuilder.header("Accept", "application/octet-stream, application/json, application/problem+json");
   ...
   * @param _file The document a job will consume. Same accepted extensions and the same 10 MB limit as the synchronous endpoints.  (required)
   * @return ArtifactUploadEnvelope
   * @throws ApiException if fails to make API call
   */
  public ArtifactUploadEnvelope uploadArtifact(@javax.annotation.Nonnull File _file) throws ApiException {
    return uploadArtifact(_file, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ArtifactUploadEnvelope uploadArtifact(@javax.annotation.Nonnull File _file, Map<String, String> headers) throws ApiException {
    ApiResponse<ArtifactUploadEnvelope> localVarResponse = uploadArtifactWithHttpInfo(_file, headers);
    return localVarResponse.getData();
  }
   ...
   * Stores a document and returns the &#x60;artifact://&#x60; reference to submit it with. This is the only way to obtain one — the asynchronous job endpoints take a reference, never a file.  The document is scanned and normalized before it is stored, exactly as the synchronous &#x60;/Document/_*&#x60; endpoints do. Images are stored as uploaded, so &#x60;Crop&#x60; and &#x60;Facematch&#x60; still see the original pixels; everything else is stored in its canonical form, which is what the job will read.  The reference is reusable and expires after 7 days — see **Artifact references** above.
   * @param _file The document a job will consume. Same accepted extensions and the same 10 MB limit as the synchronous endpoints.  (required)
   * @return ApiResponse&lt;ArtifactUploadEnvelope&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ArtifactUploadEnvelope> uploadArtifactWithHttpInfo(@javax.annotation.Nonnull File _file) throws ApiException {
    return uploadArtifactWithHttpInfo(_file, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ArtifactUploadEnvelope> uploadArtifactWithHttpInfo(@javax.annotation.Nonnull File _file, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = uploadArtifactRequestBuilder(_file, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        ...
        localVarResponseBody = ApiClient.getResponseBody(localVarResponse);
        if (localVarResponseBody == null) {
          return new ApiResponse<ArtifactUploadEnvelope>(
              localVarResponse.statusCode(),
              localVarResponse.headers().map(),
              null
          );
        ...
        ArtifactUploadEnvelope responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<ArtifactUploadEnvelope>() {});
  ...
  private HttpRequest.Builder uploadArtifactRequestBuilder(@javax.annotation.Nonnull File _file, Map<String, String> headers) throws ApiException {
    ...
    String localVarPath = "/api/v1/artifacts";
