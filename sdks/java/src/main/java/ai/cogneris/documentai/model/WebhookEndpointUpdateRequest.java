 ...
 */
@JsonPropertyOrder({
  WebhookEndpointUpdateRequest.JSON_PROPERTY_ID,
  WebhookEndpointUpdateRequest.JSON_PROPERTY_NAME,
  WebhookEndpointUpdateRequest.JSON_PROPERTY_URL,
  WebhookEndpointUpdateRequest.JSON_PROPERTY_EVENTS,
  WebhookEndpointUpdateRequest.JSON_PROPERTY_HEADERS,
  WebhookEndpointUpdateRequest.JSON_PROPERTY_BODY,
  WebhookEndpointUpdateRequest.JSON_PROPERTY_IS_ACTIVE
})
...
public class WebhookEndpointUpdateRequest {
  ...
  public WebhookEndpointUpdateRequest id(@javax.annotation.Nullable UUID id) {
    this.id = id;
    return this;
  }
  ...
  public WebhookEndpointUpdateRequest name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public WebhookEndpointUpdateRequest url(@javax.annotation.Nonnull URI url) {
    this.url = url;
    return this;
  }
  ...
  public WebhookEndpointUpdateRequest events(@javax.annotation.Nonnull List<WebhookEvent> events) {
    this.events = events;
    return this;
  }

  public WebhookEndpointUpdateRequest addEventsItem(WebhookEvent eventsItem) {
    if (this.events == null) {
  ...
  public WebhookEndpointUpdateRequest headers(@javax.annotation.Nullable Map<String, String> headers) {
    this.headers = JsonNullable.<Map<String, String>>of(headers);
    return this;
  }

  public WebhookEndpointUpdateRequest putHeadersItem(String key, String headersItem) {
  ...
  public WebhookEndpointUpdateRequest body(@javax.annotation.Nullable String body) {
  ...
  public WebhookEndpointUpdateRequest isActive(@javax.annotation.Nullable Boolean isActive) {
  ...
  /**
   * Return true if this WebhookEndpointUpdateRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, webhookEndpointUpdateRequest.id) &&
        Objects.equals(this.name, webhookEndpointUpdateRequest.name) &&
        Objects.equals(this.url, webhookEndpointUpdateRequest.url) &&
        Objects.equals(this.events, webhookEndpointUpdateRequest.events) &&
        equalsNullable(this.headers, webhookEndpointUpdateRequest.headers) &&
        equalsNullable(this.body, webhookEndpointUpdateRequest.body) &&
        Objects.equals(this.isActive, webhookEndpointUpdateRequest.isActive);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, url, events, hashCodeNullable(headers), hashCodeNullable(body), isActive);
  }
