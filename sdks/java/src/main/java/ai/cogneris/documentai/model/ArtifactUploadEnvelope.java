...
import ai.cogneris.documentai.model.Artifact;
 ...
 */
@JsonPropertyOrder({
  ArtifactUploadEnvelope.JSON_PROPERTY_DATA,
  ArtifactUploadEnvelope.JSON_PROPERTY_META,
  ArtifactUploadEnvelope.JSON_PROPERTY_HAS_ERRORS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.25.0")
public class ArtifactUploadEnvelope {
  ...
  public ArtifactUploadEnvelope() {
  }

  public ArtifactUploadEnvelope data(@javax.annotation.Nonnull Artifact data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@javax.annotation.Nonnull Artifact data) {
    this.data = data;
  }


  public ArtifactUploadEnvelope meta(@javax.annotation.Nonnull ServiceResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public ArtifactUploadEnvelope hasErrors(@javax.annotation.Nonnull Boolean hasErrors) {
  ...
  /**
   * Return true if this ArtifactUploadEnvelope object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ArtifactUploadEnvelope artifactUploadEnvelope = (ArtifactUploadEnvelope) o;
    return Objects.equals(this.data, artifactUploadEnvelope.data) &&
        Objects.equals(this.meta, artifactUploadEnvelope.meta) &&
        Objects.equals(this.hasErrors, artifactUploadEnvelope.hasErrors);
  }
  ...
  public String toString() {
    ...
    sb.append("class ArtifactUploadEnvelope {\n");
