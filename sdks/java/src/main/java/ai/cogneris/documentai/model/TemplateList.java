...
import ai.cogneris.documentai.model.Template;
 ...
 */
@JsonPropertyOrder({
  TemplateList.JSON_PROPERTY_TEMPLATES,
  TemplateList.JSON_PROPERTY_NEXT_CURSOR,
  TemplateList.JSON_PROPERTY_HAS_MORE,
  TemplateList.JSON_PROPERTY_LIMIT
})
...
public class TemplateList {
  ...
  public TemplateList templates(@javax.annotation.Nonnull List<Template> templates) {
  ...
  @JsonProperty(value = JSON_PROPERTY_TEMPLATES, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setTemplates(@javax.annotation.Nonnull List<Template> templates) {
    this.templates = templates;
  }


  public TemplateList nextCursor(@javax.annotation.Nullable String nextCursor) {
  ...
  public TemplateList hasMore(@javax.annotation.Nonnull Boolean hasMore) {
  ...
  public TemplateList limit(@javax.annotation.Nonnull Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  /**
   * Return true if this TemplateList object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.templates, templateList.templates) &&
        equalsNullable(this.nextCursor, templateList.nextCursor) &&
        Objects.equals(this.hasMore, templateList.hasMore) &&
        Objects.equals(this.limit, templateList.limit);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(templates, hashCodeNullable(nextCursor), hasMore, limit);
  }
