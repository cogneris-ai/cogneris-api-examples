 ...
 */
@JsonPropertyOrder({
  WebhookEndpointCreated.JSON_PROPERTY_ENDPOINT,
  WebhookEndpointCreated.JSON_PROPERTY_SECRET
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.25.0")
public class WebhookEndpointCreated {
  ...
  public WebhookEndpointCreated() {
  }

  public WebhookEndpointCreated endpoint(@javax.annotation.Nonnull WebhookEndpoint endpoint) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENDPOINT, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setEndpoint(@javax.annotation.Nonnull WebhookEndpoint endpoint) {
    this.endpoint = endpoint;
  }


  public WebhookEndpointCreated secret(@javax.annotation.Nonnull String secret) {
    this.secret = secret;
    return this;
  }
  ...
  /**
   * Return true if this WebhookEndpointCreated object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    WebhookEndpointCreated webhookEndpointCreated = (WebhookEndpointCreated) o;
    return Objects.equals(this.endpoint, webhookEndpointCreated.endpoint) &&
        Objects.equals(this.secret, webhookEndpointCreated.secret);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookEndpointCreated {\n");
