...
/**
 * Gets or Sets PortalSendChannel
 */
public enum PortalSendChannel {
  ...
  PortalSendChannel(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static PortalSendChannel fromValue(String value) {
    for (PortalSendChannel b : PortalSendChannel.values()) {
