...
/**
 * Gets or Sets DocumentJobSubmitOperation
 */
public enum DocumentJobSubmitOperation {
  ...
  DocumentJobSubmitOperation(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static DocumentJobSubmitOperation fromValue(String value) {
    for (DocumentJobSubmitOperation b : DocumentJobSubmitOperation.values()) {
