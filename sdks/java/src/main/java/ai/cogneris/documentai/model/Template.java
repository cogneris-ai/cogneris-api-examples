...
public class Template {
  ...
  public Template id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public Template status(@javax.annotation.Nonnull StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, template.id) &&
        ...
        equalsNullable(this.description, template.description) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, hashCodeNullable(description), status);
  }
