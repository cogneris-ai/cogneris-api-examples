...
/**
 * Gets or Sets DocumentJobOperation
 */
public enum DocumentJobOperation {
  ...
  DocumentJobOperation(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static DocumentJobOperation fromValue(String value) {
    for (DocumentJobOperation b : DocumentJobOperation.values()) {
