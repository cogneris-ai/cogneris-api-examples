 ...
 */
@JsonPropertyOrder({
  ServiceErrorEnvelope.JSON_PROPERTY_DATA,
  ServiceErrorEnvelope.JSON_PROPERTY_META,
  ServiceErrorEnvelope.JSON_PROPERTY_HAS_ERRORS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.25.0")
public class ServiceErrorEnvelope {
  ...
  public ServiceErrorEnvelope() {
  }

  public ServiceErrorEnvelope data(@javax.annotation.Nullable Map<String, Object> data) {
    this.data = data;
    return this;
  }

  public ServiceErrorEnvelope putDataItem(String key, Object dataItem) {
    if (this.data == null) {
  ...
  public ServiceErrorEnvelope meta(@javax.annotation.Nonnull ServiceResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public ServiceErrorEnvelope hasErrors(@javax.annotation.Nonnull Boolean hasErrors) {
  ...
  /**
   * Return true if this ServiceErrorEnvelope object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ServiceErrorEnvelope serviceErrorEnvelope = (ServiceErrorEnvelope) o;
    return Objects.equals(this.data, serviceErrorEnvelope.data) &&
        Objects.equals(this.meta, serviceErrorEnvelope.meta) &&
        Objects.equals(this.hasErrors, serviceErrorEnvelope.hasErrors);
  }
