...
@JsonPropertyOrder({
  ...
  ProblemDetails.JSON_PROPERTY_FIELD,
...
public class ProblemDetails {
  ...
  public ProblemDetails field(@javax.annotation.Nullable String field) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, problemDetails.type) &&
        ...
        equalsNullable(this.field, problemDetails.field) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, title, status, hashCodeNullable(detail), instance, code, correlationId, retryable, hashCodeNullable(field), errors);
  }
