...
public class SubmitDocumentJobRequest {
  ...
  /**
   * Extraction only: the id of one of your tenant&#39;s finished templates, whose schema drives the extraction. Omit it and the platform picks the template from the document, as the synchronous endpoint does. Sent with any other operation, the job is refused with &#x60;400&#x60;. An id the platform cannot resolve to a finished template of yours is refused too; the job never falls back to a generic extraction without the schema you asked for.
   * @return templateId
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.operation, submitDocumentJobRequest.operation) &&
        ...
        equalsNullable(this.templateId, submitDocumentJobRequest.templateId);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(operation, inputReference, hashCodeNullable(templateId));
  }
