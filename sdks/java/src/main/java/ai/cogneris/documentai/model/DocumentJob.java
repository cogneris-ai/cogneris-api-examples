...
@JsonPropertyOrder({
  ...
  DocumentJob.JSON_PROPERTY_TEMPLATE_ID,
...
public class DocumentJob {
  ...
  public DocumentJob templateId(@javax.annotation.Nullable UUID templateId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.jobId, documentJob.jobId) &&
        ...
        equalsNullable(this.templateId, documentJob.templateId) &&
