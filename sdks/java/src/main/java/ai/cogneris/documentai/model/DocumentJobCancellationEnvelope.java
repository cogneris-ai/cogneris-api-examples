...
import ai.cogneris.documentai.model.DocumentJobCancellation;
 ...
 */
@JsonPropertyOrder({
  DocumentJobCancellationEnvelope.JSON_PROPERTY_DATA,
  DocumentJobCancellationEnvelope.JSON_PROPERTY_META,
  DocumentJobCancellationEnvelope.JSON_PROPERTY_HAS_ERRORS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.25.0")
public class DocumentJobCancellationEnvelope {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nonnull
  private DocumentJobCancellation data;
  ...
  public DocumentJobCancellationEnvelope() {
  }

  public DocumentJobCancellationEnvelope data(@javax.annotation.Nonnull DocumentJobCancellation data) {
    this.data = data;
    return this;
  }
  ...
  public DocumentJobCancellation getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@javax.annotation.Nonnull DocumentJobCancellation data) {
    this.data = data;
  }


  public DocumentJobCancellationEnvelope meta(@javax.annotation.Nonnull ServiceResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public DocumentJobCancellationEnvelope hasErrors(@javax.annotation.Nonnull Boolean hasErrors) {
  ...
  /**
   * Return true if this DocumentJobCancellationEnvelope object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DocumentJobCancellationEnvelope documentJobCancellationEnvelope = (DocumentJobCancellationEnvelope) o;
    return Objects.equals(this.data, documentJobCancellationEnvelope.data) &&
        Objects.equals(this.meta, documentJobCancellationEnvelope.meta) &&
        Objects.equals(this.hasErrors, documentJobCancellationEnvelope.hasErrors);
  }
  ...
  public String toString() {
    ...
    sb.append("class DocumentJobCancellationEnvelope {\n");
