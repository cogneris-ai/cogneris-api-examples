 ...
 */
@JsonPropertyOrder({
  WebhookEndpointList.JSON_PROPERTY_ENDPOINTS
})
...
public class WebhookEndpointList {
  ...
  public WebhookEndpointList endpoints(@javax.annotation.Nonnull List<WebhookEndpoint> endpoints) {
    this.endpoints = endpoints;
    return this;
  }

  public WebhookEndpointList addEndpointsItem(WebhookEndpoint endpointsItem) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENDPOINTS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setEndpoints(@javax.annotation.Nonnull List<WebhookEndpoint> endpoints) {
    this.endpoints = endpoints;
  }


  /**
   * Return true if this WebhookEndpointList object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.endpoints, webhookEndpointList.endpoints);
  }
