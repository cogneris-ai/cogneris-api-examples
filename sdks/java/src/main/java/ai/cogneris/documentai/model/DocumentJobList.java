 ...
 */
@JsonPropertyOrder({
  DocumentJobList.JSON_PROPERTY_JOBS,
  DocumentJobList.JSON_PROPERTY_NEXT_CURSOR,
  DocumentJobList.JSON_PROPERTY_HAS_MORE,
  DocumentJobList.JSON_PROPERTY_LIMIT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.25.0")
public class DocumentJobList {
  public static final String JSON_PROPERTY_JOBS = "jobs";
  @javax.annotation.Nonnull
  private List<DocumentJob> jobs = new ArrayList<>();
  ...
  public DocumentJobList() {
  }

  public DocumentJobList jobs(@javax.annotation.Nonnull List<DocumentJob> jobs) {
    this.jobs = jobs;
    return this;
  }

  public DocumentJobList addJobsItem(DocumentJob jobsItem) {
    if (this.jobs == null) {
  ...
  public List<DocumentJob> getJobs() {
    return jobs;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_JOBS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setJobs(@javax.annotation.Nonnull List<DocumentJob> jobs) {
    this.jobs = jobs;
  }


  public DocumentJobList nextCursor(@javax.annotation.Nullable String nextCursor) {
  ...
  public DocumentJobList hasMore(@javax.annotation.Nonnull Boolean hasMore) {
  ...
  public DocumentJobList limit(@javax.annotation.Nonnull Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  /**
   * Return true if this DocumentJobList object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DocumentJobList documentJobList = (DocumentJobList) o;
    return Objects.equals(this.jobs, documentJobList.jobs) &&
        equalsNullable(this.nextCursor, documentJobList.nextCursor) &&
        Objects.equals(this.hasMore, documentJobList.hasMore) &&
        Objects.equals(this.limit, documentJobList.limit);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(jobs, hashCodeNullable(nextCursor), hasMore, limit);
  }
  ...
  public String toString() {
    ...
    sb.append("class DocumentJobList {\n");
