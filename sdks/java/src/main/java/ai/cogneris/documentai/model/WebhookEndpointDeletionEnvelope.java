...
import ai.cogneris.documentai.model.WebhookEndpointDeletion;
 ...
 */
@JsonPropertyOrder({
  WebhookEndpointDeletionEnvelope.JSON_PROPERTY_DATA,
  WebhookEndpointDeletionEnvelope.JSON_PROPERTY_META,
  WebhookEndpointDeletionEnvelope.JSON_PROPERTY_HAS_ERRORS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.25.0")
public class WebhookEndpointDeletionEnvelope {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nonnull
  private WebhookEndpointDeletion data;
  ...
  public WebhookEndpointDeletionEnvelope() {
  }

  public WebhookEndpointDeletionEnvelope data(@javax.annotation.Nonnull WebhookEndpointDeletion data) {
    this.data = data;
    return this;
  }
  ...
  public WebhookEndpointDeletion getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@javax.annotation.Nonnull WebhookEndpointDeletion data) {
    this.data = data;
  }


  public WebhookEndpointDeletionEnvelope meta(@javax.annotation.Nonnull ServiceResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public WebhookEndpointDeletionEnvelope hasErrors(@javax.annotation.Nonnull Boolean hasErrors) {
  ...
  /**
   * Return true if this WebhookEndpointDeletionEnvelope object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    WebhookEndpointDeletionEnvelope webhookEndpointDeletionEnvelope = (WebhookEndpointDeletionEnvelope) o;
    return Objects.equals(this.data, webhookEndpointDeletionEnvelope.data) &&
        Objects.equals(this.meta, webhookEndpointDeletionEnvelope.meta) &&
        Objects.equals(this.hasErrors, webhookEndpointDeletionEnvelope.hasErrors);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookEndpointDeletionEnvelope {\n");
