 ...
 */
@JsonPropertyOrder({
  PortalMagicLinkOptIn.JSON_PROPERTY_SOURCE,
  PortalMagicLinkOptIn.JSON_PROPERTY_EVIDENCE_TEXT,
  PortalMagicLinkOptIn.JSON_PROPERTY_EVIDENCE_URL,
  PortalMagicLinkOptIn.JSON_PROPERTY_COLLECTED_WHEN
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.25.0")
public class PortalMagicLinkOptIn {
  /**
  ...
  public enum SourceEnum {
    ...
    IN_PERSON(String.valueOf("in_person")),
  ...
  public static final String JSON_PROPERTY_EVIDENCE_TEXT = "evidenceText";
  @javax.annotation.Nonnull
  private String evidenceText;

  public static final String JSON_PROPERTY_EVIDENCE_URL = "evidenceUrl";
  private JsonNullable<String> evidenceUrl = JsonNullable.<String>undefined();

  public static final String JSON_PROPERTY_COLLECTED_WHEN = "collectedWhen";
  private JsonNullable<OffsetDateTime> collectedWhen = JsonNullable.<OffsetDateTime>undefined();

  public PortalMagicLinkOptIn() {
  }

  public PortalMagicLinkOptIn source(@javax.annotation.Nonnull SourceEnum source) {
    this.source = source;
    return this;
  }
  ...
  public PortalMagicLinkOptIn evidenceText(@javax.annotation.Nonnull String evidenceText) {
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_EVIDENCE_TEXT, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  @JsonProperty(value = JSON_PROPERTY_EVIDENCE_TEXT, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setEvidenceText(@javax.annotation.Nonnull String evidenceText) {
    this.evidenceText = evidenceText;
  }


  public PortalMagicLinkOptIn evidenceUrl(@javax.annotation.Nullable String evidenceUrl) {
    this.evidenceUrl = JsonNullable.<String>of(evidenceUrl);
    return this;
  }
  ...
  public String getEvidenceUrl() {
        return evidenceUrl.orElse(null);
  }

  @JsonProperty(value = JSON_PROPERTY_EVIDENCE_URL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<String> getEvidenceUrl_JsonNullable() {
    return evidenceUrl;
  }

  @JsonProperty(JSON_PROPERTY_EVIDENCE_URL)
  public void setEvidenceUrl_JsonNullable(JsonNullable<String> evidenceUrl) {
    this.evidenceUrl = evidenceUrl;
  }

  public void setEvidenceUrl(@javax.annotation.Nullable String evidenceUrl) {
    this.evidenceUrl = JsonNullable.<String>of(evidenceUrl);
  }


  public PortalMagicLinkOptIn collectedWhen(@javax.annotation.Nullable OffsetDateTime collectedWhen) {
    this.collectedWhen = JsonNullable.<OffsetDateTime>of(collectedWhen);
    return this;
  }
   ...
   * @return collectedWhen
   */
  @javax.annotation.Nullable
  @JsonIgnore
  public OffsetDateTime getCollectedWhen() {
        return collectedWhen.orElse(null);
  }

  @JsonProperty(value = JSON_PROPERTY_COLLECTED_WHEN, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<OffsetDateTime> getCollectedWhen_JsonNullable() {
    return collectedWhen;
  }

  @JsonProperty(JSON_PROPERTY_COLLECTED_WHEN)
  public void setCollectedWhen_JsonNullable(JsonNullable<OffsetDateTime> collectedWhen) {
    this.collectedWhen = collectedWhen;
  }

  public void setCollectedWhen(@javax.annotation.Nullable OffsetDateTime collectedWhen) {
    this.collectedWhen = JsonNullable.<OffsetDateTime>of(collectedWhen);
  }


  /**
   * Return true if this PortalMagicLinkOptIn object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PortalMagicLinkOptIn portalMagicLinkOptIn = (PortalMagicLinkOptIn) o;
    return Objects.equals(this.source, portalMagicLinkOptIn.source) &&
        Objects.equals(this.evidenceText, portalMagicLinkOptIn.evidenceText) &&
        equalsNullable(this.evidenceUrl, portalMagicLinkOptIn.evidenceUrl) &&
        equalsNullable(this.collectedWhen, portalMagicLinkOptIn.collectedWhen);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(source, evidenceText, hashCodeNullable(evidenceUrl), hashCodeNullable(collectedWhen));
  }
  ...
  public String toString() {
    ...
    sb.append("    evidenceUrl: ").append(toIndentedString(evidenceUrl)).append("\n");
    sb.append("    collectedWhen: ").append(toIndentedString(collectedWhen)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `evidenceText` to the URL query string
    if (getEvidenceText() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sevidenceText%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEvidenceText()))));
    }

    // add `evidenceUrl` to the URL query string
    if (getEvidenceUrl() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sevidenceUrl%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEvidenceUrl()))));
    }

    // add `collectedWhen` to the URL query string
    if (getCollectedWhen() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%scollectedWhen%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getCollectedWhen()))));
    }
