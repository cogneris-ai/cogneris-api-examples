...
import ai.cogneris.documentai.model.WebhookEndpointList;
 ...
 */
@JsonPropertyOrder({
  WebhookEndpointListEnvelope.JSON_PROPERTY_DATA,
  WebhookEndpointListEnvelope.JSON_PROPERTY_META,
  WebhookEndpointListEnvelope.JSON_PROPERTY_HAS_ERRORS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.25.0")
public class WebhookEndpointListEnvelope {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nonnull
  private WebhookEndpointList data;
  ...
  public WebhookEndpointListEnvelope() {
  }

  public WebhookEndpointListEnvelope data(@javax.annotation.Nonnull WebhookEndpointList data) {
    this.data = data;
    return this;
  }
  ...
  public WebhookEndpointList getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@javax.annotation.Nonnull WebhookEndpointList data) {
    this.data = data;
  }


  public WebhookEndpointListEnvelope meta(@javax.annotation.Nonnull ServiceResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public WebhookEndpointListEnvelope hasErrors(@javax.annotation.Nonnull Boolean hasErrors) {
  ...
  /**
   * Return true if this WebhookEndpointListEnvelope object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    WebhookEndpointListEnvelope webhookEndpointListEnvelope = (WebhookEndpointListEnvelope) o;
    return Objects.equals(this.data, webhookEndpointListEnvelope.data) &&
        Objects.equals(this.meta, webhookEndpointListEnvelope.meta) &&
        Objects.equals(this.hasErrors, webhookEndpointListEnvelope.hasErrors);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookEndpointListEnvelope {\n");
