 ...
 */
@JsonPropertyOrder({
  DocumentJobCancellation.JSON_PROPERTY_JOB_ID,
  DocumentJobCancellation.JSON_PROPERTY_CANCELLATION_REQUESTED
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.25.0")
public class DocumentJobCancellation {
  ...
  public DocumentJobCancellation() {
  }

  public DocumentJobCancellation jobId(@javax.annotation.Nonnull UUID jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public DocumentJobCancellation cancellationRequested(@javax.annotation.Nonnull Boolean cancellationRequested) {
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_CANCELLATION_REQUESTED, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  @JsonProperty(value = JSON_PROPERTY_CANCELLATION_REQUESTED, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCancellationRequested(@javax.annotation.Nonnull Boolean cancellationRequested) {
    this.cancellationRequested = cancellationRequested;
  }


  /**
   * Return true if this DocumentJobCancellation object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DocumentJobCancellation documentJobCancellation = (DocumentJobCancellation) o;
    return Objects.equals(this.jobId, documentJobCancellation.jobId) &&
        Objects.equals(this.cancellationRequested, documentJobCancellation.cancellationRequested);
  }

  @Override
  public int hashCode() {
    return Objects.hash(jobId, cancellationRequested);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DocumentJobCancellation {\n");
