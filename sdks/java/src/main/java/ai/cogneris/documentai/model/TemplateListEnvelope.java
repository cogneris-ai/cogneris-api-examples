...
import ai.cogneris.documentai.model.TemplateList;
 ...
 */
@JsonPropertyOrder({
  TemplateListEnvelope.JSON_PROPERTY_DATA,
  TemplateListEnvelope.JSON_PROPERTY_META,
  TemplateListEnvelope.JSON_PROPERTY_HAS_ERRORS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.25.0")
public class TemplateListEnvelope {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nonnull
  private TemplateList data;
  ...
  public TemplateListEnvelope() {
  }

  public TemplateListEnvelope data(@javax.annotation.Nonnull TemplateList data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@javax.annotation.Nonnull TemplateList data) {
    this.data = data;
  }


  public TemplateListEnvelope meta(@javax.annotation.Nonnull ServiceResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public TemplateListEnvelope hasErrors(@javax.annotation.Nonnull Boolean hasErrors) {
  ...
  /**
   * Return true if this TemplateListEnvelope object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TemplateListEnvelope templateListEnvelope = (TemplateListEnvelope) o;
    return Objects.equals(this.data, templateListEnvelope.data) &&
        Objects.equals(this.meta, templateListEnvelope.meta) &&
        Objects.equals(this.hasErrors, templateListEnvelope.hasErrors);
  }
  ...
  public String toString() {
    ...
    sb.append("class TemplateListEnvelope {\n");
