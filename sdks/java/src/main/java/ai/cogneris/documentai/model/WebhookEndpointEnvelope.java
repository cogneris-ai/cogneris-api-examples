...
import ai.cogneris.documentai.model.WebhookEndpoint;
 ...
 */
@JsonPropertyOrder({
  WebhookEndpointEnvelope.JSON_PROPERTY_DATA,
  WebhookEndpointEnvelope.JSON_PROPERTY_META,
  WebhookEndpointEnvelope.JSON_PROPERTY_HAS_ERRORS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.25.0")
public class WebhookEndpointEnvelope {
  ...
  public WebhookEndpointEnvelope() {
  }

  public WebhookEndpointEnvelope data(@javax.annotation.Nonnull WebhookEndpoint data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@javax.annotation.Nonnull WebhookEndpoint data) {
    this.data = data;
  }


  public WebhookEndpointEnvelope meta(@javax.annotation.Nonnull ServiceResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public WebhookEndpointEnvelope hasErrors(@javax.annotation.Nonnull Boolean hasErrors) {
  ...
  /**
   * Return true if this WebhookEndpointEnvelope object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    WebhookEndpointEnvelope webhookEndpointEnvelope = (WebhookEndpointEnvelope) o;
    return Objects.equals(this.data, webhookEndpointEnvelope.data) &&
        Objects.equals(this.meta, webhookEndpointEnvelope.meta) &&
        Objects.equals(this.hasErrors, webhookEndpointEnvelope.hasErrors);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookEndpointEnvelope {\n");
