 ...
 */
@JsonPropertyOrder({
  FaceExtraction.JSON_PROPERTY_SOURCE_DOCUMENT_ID,
  FaceExtraction.JSON_PROPERTY_HAS_FACE,
  FaceExtraction.JSON_PROPERTY_DOCUMENT_TYPE,
  FaceExtraction.JSON_PROPERTY_CROP_SIGNED_URL
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.25.0")
public class FaceExtraction {
  public static final String JSON_PROPERTY_SOURCE_DOCUMENT_ID = "sourceDocumentId";
  @javax.annotation.Nullable
  private UUID sourceDocumentId;

  public static final String JSON_PROPERTY_HAS_FACE = "hasFace";
  @javax.annotation.Nullable
  ...
  public static final String JSON_PROPERTY_CROP_SIGNED_URL = "cropSignedUrl";
  private JsonNullable<String> cropSignedUrl = JsonNullable.<String>undefined();

  public FaceExtraction() {
  }

  public FaceExtraction sourceDocumentId(@javax.annotation.Nullable UUID sourceDocumentId) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_SOURCE_DOCUMENT_ID, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_SOURCE_DOCUMENT_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSourceDocumentId(@javax.annotation.Nullable UUID sourceDocumentId) {
    this.sourceDocumentId = sourceDocumentId;
  }


  public FaceExtraction hasFace(@javax.annotation.Nullable Boolean hasFace) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_HAS_FACE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_HAS_FACE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setHasFace(@javax.annotation.Nullable Boolean hasFace) {
    this.hasFace = hasFace;
  }


  public FaceExtraction documentType(@javax.annotation.Nullable String documentType) {
  ...
  public FaceExtraction cropSignedUrl(@javax.annotation.Nullable String cropSignedUrl) {
    this.cropSignedUrl = JsonNullable.<String>of(cropSignedUrl);
    return this;
  }

  /**
   * Signed URL of the face crop. Null when none was produced.
   * @return cropSignedUrl
   */
  @javax.annotation.Nullable
  @JsonIgnore
  public String getCropSignedUrl() {
        return cropSignedUrl.orElse(null);
  }

  @JsonProperty(value = JSON_PROPERTY_CROP_SIGNED_URL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<String> getCropSignedUrl_JsonNullable() {
    return cropSignedUrl;
  }

  @JsonProperty(JSON_PROPERTY_CROP_SIGNED_URL)
  public void setCropSignedUrl_JsonNullable(JsonNullable<String> cropSignedUrl) {
    this.cropSignedUrl = cropSignedUrl;
  }

  public void setCropSignedUrl(@javax.annotation.Nullable String cropSignedUrl) {
    this.cropSignedUrl = JsonNullable.<String>of(cropSignedUrl);
  }


  /**
   * Return true if this FaceExtraction object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    FaceExtraction faceExtraction = (FaceExtraction) o;
    return Objects.equals(this.sourceDocumentId, faceExtraction.sourceDocumentId) &&
        Objects.equals(this.hasFace, faceExtraction.hasFace) &&
        Objects.equals(this.documentType, faceExtraction.documentType) &&
        equalsNullable(this.cropSignedUrl, faceExtraction.cropSignedUrl);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(sourceDocumentId, hasFace, documentType, hashCodeNullable(cropSignedUrl));
  }
  ...
  public String toString() {
    ...
    sb.append("class FaceExtraction {\n");
    sb.append("    sourceDocumentId: ").append(toIndentedString(sourceDocumentId)).append("\n");
    sb.append("    hasFace: ").append(toIndentedString(hasFace)).append("\n");
    sb.append("    documentType: ").append(toIndentedString(documentType)).append("\n");
    sb.append("    cropSignedUrl: ").append(toIndentedString(cropSignedUrl)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `sourceDocumentId` to the URL query string
    if (getSourceDocumentId() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%ssourceDocumentId%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSourceDocumentId()))));
    }

    // add `hasFace` to the URL query string
    if (getHasFace() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%shasFace%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getHasFace()))));
    }
    ...
    // add `cropSignedUrl` to the URL query string
    if (getCropSignedUrl() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%scropSignedUrl%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getCropSignedUrl()))));
    }
