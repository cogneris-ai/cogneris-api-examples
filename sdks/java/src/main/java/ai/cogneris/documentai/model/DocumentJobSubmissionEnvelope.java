...
import ai.cogneris.documentai.model.DocumentJobSubmission;
 ...
 */
@JsonPropertyOrder({
  DocumentJobSubmissionEnvelope.JSON_PROPERTY_DATA,
  DocumentJobSubmissionEnvelope.JSON_PROPERTY_META,
  DocumentJobSubmissionEnvelope.JSON_PROPERTY_HAS_ERRORS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.25.0")
public class DocumentJobSubmissionEnvelope {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nonnull
  private DocumentJobSubmission data;
  ...
  public DocumentJobSubmissionEnvelope() {
  }

  public DocumentJobSubmissionEnvelope data(@javax.annotation.Nonnull DocumentJobSubmission data) {
    this.data = data;
    return this;
  }
  ...
  public DocumentJobSubmission getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@javax.annotation.Nonnull DocumentJobSubmission data) {
    this.data = data;
  }


  public DocumentJobSubmissionEnvelope meta(@javax.annotation.Nonnull ServiceResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public DocumentJobSubmissionEnvelope hasErrors(@javax.annotation.Nonnull Boolean hasErrors) {
  ...
  /**
   * Return true if this DocumentJobSubmissionEnvelope object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DocumentJobSubmissionEnvelope documentJobSubmissionEnvelope = (DocumentJobSubmissionEnvelope) o;
    return Objects.equals(this.data, documentJobSubmissionEnvelope.data) &&
        Objects.equals(this.meta, documentJobSubmissionEnvelope.meta) &&
        Objects.equals(this.hasErrors, documentJobSubmissionEnvelope.hasErrors);
  }
  ...
  public String toString() {
    ...
    sb.append("class DocumentJobSubmissionEnvelope {\n");
