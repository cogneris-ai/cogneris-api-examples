...
import ai.cogneris.documentai.model.QualityFinding;
 ...
 */
@JsonPropertyOrder({
  QualityAssessment.JSON_PROPERTY_OVERALL,
  QualityAssessment.JSON_PROPERTY_FINDINGS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.25.0")
public class QualityAssessment {
  public static final String JSON_PROPERTY_OVERALL = "overall";
  @javax.annotation.Nonnull
  private QualityVerdict overall;

  public static final String JSON_PROPERTY_FINDINGS = "findings";
  @javax.annotation.Nonnull
  private List<QualityFinding> findings = new ArrayList<>();

  public QualityAssessment() {
  }

  public QualityAssessment overall(@javax.annotation.Nonnull QualityVerdict overall) {
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_OVERALL, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public QualityVerdict getOverall() {
    return overall;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_OVERALL, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setOverall(@javax.annotation.Nonnull QualityVerdict overall) {
    this.overall = overall;
  }


  public QualityAssessment findings(@javax.annotation.Nonnull List<QualityFinding> findings) {
    this.findings = findings;
    return this;
  }

  public QualityAssessment addFindingsItem(QualityFinding findingsItem) {
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_FINDINGS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  @JsonProperty(value = JSON_PROPERTY_FINDINGS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setFindings(@javax.annotation.Nonnull List<QualityFinding> findings) {
    this.findings = findings;
  }


  /**
   * Return true if this QualityAssessment object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    QualityAssessment qualityAssessment = (QualityAssessment) o;
    return Objects.equals(this.overall, qualityAssessment.overall) &&
        Objects.equals(this.findings, qualityAssessment.findings);
  }

  @Override
  public int hashCode() {
    return Objects.hash(overall, findings);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class QualityAssessment {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `overall` to the URL query string
    if (getOverall() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%soverall%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getOverall()))));
    }
