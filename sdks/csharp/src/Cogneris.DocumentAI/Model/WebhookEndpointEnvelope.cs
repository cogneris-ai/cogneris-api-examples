...
namespace Cogneris.DocumentAI.Model
{
    ...
    /// </summary>
    public partial class WebhookEndpointEnvelope : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEndpointEnvelope" /> class.
        /// </summary>
        /// <param name="data">data</param>
        /// <param name="meta">meta</param>
        /// <param name="hasErrors">hasErrors</param>
        [JsonConstructor]
        public WebhookEndpointEnvelope(WebhookEndpoint data, ServiceResponseMeta meta, bool hasErrors)
        {
            Data = data;
            Meta = meta;
            HasErrors = hasErrors;
    ...
    /// <summary>
    /// A Json converter for type <see cref="WebhookEndpointEnvelope" />
    /// </summary>
    public partial class WebhookEndpointEnvelopeJsonConverter : JsonConverter<WebhookEndpointEnvelope>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEndpointEnvelopeJsonConverter" /> class.
        /// </summary>
        public WebhookEndpointEnvelopeJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="WebhookEndpointEnvelope" />
        /// </summary>
        ...
        public override WebhookEndpointEnvelope Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<WebhookEndpoint?> data = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "data":
                            data = new Option<WebhookEndpoint?>(JsonSerializer.Deserialize<WebhookEndpoint>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "meta":
            ...
            if (!data.IsSet)
                throw new ArgumentException("Property is required for class WebhookEndpointEnvelope.", nameof(data));

            if (!meta.IsSet)
                throw new ArgumentException("Property is required for class WebhookEndpointEnvelope.", nameof(meta));

            if (!hasErrors.IsSet)
                throw new ArgumentException("Property is required for class WebhookEndpointEnvelope.", nameof(hasErrors));

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class WebhookEndpointEnvelope.");

            if (meta.IsSet && meta.Value == null)
                throw new ArgumentNullException(nameof(meta), "Property is not nullable for class WebhookEndpointEnvelope.");

            if (hasErrors.IsSet && hasErrors.Value == null)
                throw new ArgumentNullException(nameof(hasErrors), "Property is not nullable for class WebhookEndpointEnvelope.");

            return new WebhookEndpointEnvelope(data.Value!, meta.Value!, hasErrors.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="WebhookEndpointEnvelope" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="webhookEndpointEnvelope"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, WebhookEndpointEnvelope webhookEndpointEnvelope, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, webhookEndpointEnvelope, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="WebhookEndpointEnvelope" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="webhookEndpointEnvelope"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, WebhookEndpointEnvelope webhookEndpointEnvelope, JsonSerializerOptions jsonSerializerOptions)
        {
            if (webhookEndpointEnvelope.Data == null)
                throw new ArgumentNullException(nameof(webhookEndpointEnvelope.Data), "Property is required for class WebhookEndpointEnvelope.");

            if (webhookEndpointEnvelope.Meta == null)
                throw new ArgumentNullException(nameof(webhookEndpointEnvelope.Meta), "Property is required for class WebhookEndpointEnvelope.");

            writer.WritePropertyName("data");
            JsonSerializer.Serialize(writer, webhookEndpointEnvelope.Data, jsonSerializerOptions);
            writer.WritePropertyName("meta");
            JsonSerializer.Serialize(writer, webhookEndpointEnvelope.Meta, jsonSerializerOptions);
            writer.WriteBoolean("hasErrors", webhookEndpointEnvelope.HasErrors);
        }
    }
}
