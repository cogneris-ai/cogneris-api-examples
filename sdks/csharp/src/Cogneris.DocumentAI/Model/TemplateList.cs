...
namespace Cogneris.DocumentAI.Model
{
    ...
    public partial class TemplateList : IValidatableObject
    {
        ...
        [JsonConstructor]
        public TemplateList(List<Template> templates, bool hasMore, int limit, Option<string?> nextCursor = default)
        {
            Templates = templates;
            HasMore = hasMore;
            Limit = limit;
    ...
    /// <summary>
    /// A Json converter for type <see cref="TemplateList" />
    /// </summary>
    public partial class TemplateListJsonConverter : JsonConverter<TemplateList>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateListJsonConverter" /> class.
        /// </summary>
        public TemplateListJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="TemplateList" />
        /// </summary>
        ...
        public override TemplateList Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<Template>?> templates = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "templates":
                            templates = new Option<List<Template>?>(JsonSerializer.Deserialize<List<Template>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "hasMore":
            ...
            if (!templates.IsSet)
                throw new ArgumentException("Property is required for class TemplateList.", nameof(templates));

            if (!hasMore.IsSet)
                throw new ArgumentException("Property is required for class TemplateList.", nameof(hasMore));

            if (!limit.IsSet)
                throw new ArgumentException("Property is required for class TemplateList.", nameof(limit));

            if (templates.IsSet && templates.Value == null)
                throw new ArgumentNullException(nameof(templates), "Property is not nullable for class TemplateList.");

            if (hasMore.IsSet && hasMore.Value == null)
                throw new ArgumentNullException(nameof(hasMore), "Property is not nullable for class TemplateList.");

            if (limit.IsSet && limit.Value == null)
                throw new ArgumentNullException(nameof(limit), "Property is not nullable for class TemplateList.");

            return new TemplateList(templates.Value!, hasMore.Value!.Value!, limit.Value!.Value!, nextCursor);
        }

        /// <summary>
        /// Serializes a <see cref="TemplateList" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="templateList"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TemplateList templateList, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, templateList, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TemplateList" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="templateList"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TemplateList templateList, JsonSerializerOptions jsonSerializerOptions)
        {
            if (templateList.Templates == null)
                throw new ArgumentNullException(nameof(templateList.Templates), "Property is required for class TemplateList.");

            writer.WritePropertyName("templates");
            JsonSerializer.Serialize(writer, templateList.Templates, jsonSerializerOptions);
            writer.WriteBoolean("hasMore", templateList.HasMore);

            writer.WriteNumber("limit", templateList.Limit);

            if (templateList.NextCursorOption.IsSet)
                if (templateList.NextCursorOption.Value != null)
                    writer.WriteString("nextCursor", templateList.NextCursor);
                else
