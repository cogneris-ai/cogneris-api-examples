...
namespace Cogneris.DocumentAI.Model
{
    ...
    /// </summary>
    public partial class WebhookEndpointCreated : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEndpointCreated" /> class.
        /// </summary>
        /// <param name="endpoint">endpoint</param>
        /// <param name="secret">The signing secret. Shown once — store it now.</param>
        [JsonConstructor]
        public WebhookEndpointCreated(WebhookEndpoint endpoint, string secret)
        {
            Endpoint = endpoint;
            Secret = secret;
            OnCreated();
        ...
        /// </summary>
        /// <value>The signing secret. Shown once — store it now.</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="WebhookEndpointCreated" />
    /// </summary>
    public partial class WebhookEndpointCreatedJsonConverter : JsonConverter<WebhookEndpointCreated>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEndpointCreatedJsonConverter" /> class.
        /// </summary>
        public WebhookEndpointCreatedJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="WebhookEndpointCreated" />
        /// </summary>
        ...
        public override WebhookEndpointCreated Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<WebhookEndpoint?> endpoint = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "endpoint":
                            endpoint = new Option<WebhookEndpoint?>(JsonSerializer.Deserialize<WebhookEndpoint>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "secret":
            ...
            if (!endpoint.IsSet)
                throw new ArgumentException("Property is required for class WebhookEndpointCreated.", nameof(endpoint));

            if (!secret.IsSet)
                throw new ArgumentException("Property is required for class WebhookEndpointCreated.", nameof(secret));

            if (endpoint.IsSet && endpoint.Value == null)
                throw new ArgumentNullException(nameof(endpoint), "Property is not nullable for class WebhookEndpointCreated.");

            if (secret.IsSet && secret.Value == null)
                throw new ArgumentNullException(nameof(secret), "Property is not nullable for class WebhookEndpointCreated.");

            return new WebhookEndpointCreated(endpoint.Value!, secret.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="WebhookEndpointCreated" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="webhookEndpointCreated"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, WebhookEndpointCreated webhookEndpointCreated, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, webhookEndpointCreated, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="WebhookEndpointCreated" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="webhookEndpointCreated"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, WebhookEndpointCreated webhookEndpointCreated, JsonSerializerOptions jsonSerializerOptions)
        {
            if (webhookEndpointCreated.Endpoint == null)
                throw new ArgumentNullException(nameof(webhookEndpointCreated.Endpoint), "Property is required for class WebhookEndpointCreated.");

            if (webhookEndpointCreated.Secret == null)
                throw new ArgumentNullException(nameof(webhookEndpointCreated.Secret), "Property is required for class WebhookEndpointCreated.");

            writer.WritePropertyName("endpoint");
            JsonSerializer.Serialize(writer, webhookEndpointCreated.Endpoint, jsonSerializerOptions);
            writer.WriteString("secret", webhookEndpointCreated.Secret);
        }
    }
}
