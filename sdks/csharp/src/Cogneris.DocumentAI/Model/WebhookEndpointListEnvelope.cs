...
namespace Cogneris.DocumentAI.Model
{
    ...
    /// </summary>
    public partial class WebhookEndpointListEnvelope : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEndpointListEnvelope" /> class.
        /// </summary>
        /// <param name="data">data</param>
        /// <param name="meta">meta</param>
        /// <param name="hasErrors">hasErrors</param>
        [JsonConstructor]
        public WebhookEndpointListEnvelope(WebhookEndpointList data, ServiceResponseMeta meta, bool hasErrors)
        {
            Data = data;
            Meta = meta;
            HasErrors = hasErrors;
        ...
        public WebhookEndpointList Data { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="WebhookEndpointListEnvelope" />
    /// </summary>
    public partial class WebhookEndpointListEnvelopeJsonConverter : JsonConverter<WebhookEndpointListEnvelope>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEndpointListEnvelopeJsonConverter" /> class.
        /// </summary>
        public WebhookEndpointListEnvelopeJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="WebhookEndpointListEnvelope" />
        /// </summary>
        ...
        public override WebhookEndpointListEnvelope Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<WebhookEndpointList?> data = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "data":
                            data = new Option<WebhookEndpointList?>(JsonSerializer.Deserialize<WebhookEndpointList>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "meta":
            ...
            if (!data.IsSet)
                throw new ArgumentException("Property is required for class WebhookEndpointListEnvelope.", nameof(data));

            if (!meta.IsSet)
                throw new ArgumentException("Property is required for class WebhookEndpointListEnvelope.", nameof(meta));

            if (!hasErrors.IsSet)
                throw new ArgumentException("Property is required for class WebhookEndpointListEnvelope.", nameof(hasErrors));

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class WebhookEndpointListEnvelope.");

            if (meta.IsSet && meta.Value == null)
                throw new ArgumentNullException(nameof(meta), "Property is not nullable for class WebhookEndpointListEnvelope.");

            if (hasErrors.IsSet && hasErrors.Value == null)
                throw new ArgumentNullException(nameof(hasErrors), "Property is not nullable for class WebhookEndpointListEnvelope.");

            return new WebhookEndpointListEnvelope(data.Value!, meta.Value!, hasErrors.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="WebhookEndpointListEnvelope" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="webhookEndpointListEnvelope"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, WebhookEndpointListEnvelope webhookEndpointListEnvelope, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, webhookEndpointListEnvelope, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="WebhookEndpointListEnvelope" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="webhookEndpointListEnvelope"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, WebhookEndpointListEnvelope webhookEndpointListEnvelope, JsonSerializerOptions jsonSerializerOptions)
        {
            if (webhookEndpointListEnvelope.Data == null)
                throw new ArgumentNullException(nameof(webhookEndpointListEnvelope.Data), "Property is required for class WebhookEndpointListEnvelope.");

            if (webhookEndpointListEnvelope.Meta == null)
                throw new ArgumentNullException(nameof(webhookEndpointListEnvelope.Meta), "Property is required for class WebhookEndpointListEnvelope.");

            writer.WritePropertyName("data");
            JsonSerializer.Serialize(writer, webhookEndpointListEnvelope.Data, jsonSerializerOptions);
            writer.WritePropertyName("meta");
            JsonSerializer.Serialize(writer, webhookEndpointListEnvelope.Meta, jsonSerializerOptions);
            writer.WriteBoolean("hasErrors", webhookEndpointListEnvelope.HasErrors);
        }
    }
}
