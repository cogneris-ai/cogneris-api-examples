...
namespace Cogneris.DocumentAI.Model
{
    ...
    /// </summary>
    public partial class WebhookEndpointDeletionEnvelope : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEndpointDeletionEnvelope" /> class.
        /// </summary>
        /// <param name="data">data</param>
        /// <param name="meta">meta</param>
        /// <param name="hasErrors">hasErrors</param>
        [JsonConstructor]
        public WebhookEndpointDeletionEnvelope(WebhookEndpointDeletion data, ServiceResponseMeta meta, bool hasErrors)
        {
            Data = data;
            Meta = meta;
            HasErrors = hasErrors;
        ...
        public WebhookEndpointDeletion Data { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="WebhookEndpointDeletionEnvelope" />
    /// </summary>
    public partial class WebhookEndpointDeletionEnvelopeJsonConverter : JsonConverter<WebhookEndpointDeletionEnvelope>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEndpointDeletionEnvelopeJsonConverter" /> class.
        /// </summary>
        public WebhookEndpointDeletionEnvelopeJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="WebhookEndpointDeletionEnvelope" />
        /// </summary>
        ...
        public override WebhookEndpointDeletionEnvelope Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<WebhookEndpointDeletion?> data = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "data":
                            data = new Option<WebhookEndpointDeletion?>(JsonSerializer.Deserialize<WebhookEndpointDeletion>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "meta":
            ...
            if (!data.IsSet)
                throw new ArgumentException("Property is required for class WebhookEndpointDeletionEnvelope.", nameof(data));

            if (!meta.IsSet)
                throw new ArgumentException("Property is required for class WebhookEndpointDeletionEnvelope.", nameof(meta));

            if (!hasErrors.IsSet)
                throw new ArgumentException("Property is required for class WebhookEndpointDeletionEnvelope.", nameof(hasErrors));

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class WebhookEndpointDeletionEnvelope.");

            if (meta.IsSet && meta.Value == null)
                throw new ArgumentNullException(nameof(meta), "Property is not nullable for class WebhookEndpointDeletionEnvelope.");

            if (hasErrors.IsSet && hasErrors.Value == null)
                throw new ArgumentNullException(nameof(hasErrors), "Property is not nullable for class WebhookEndpointDeletionEnvelope.");

            return new WebhookEndpointDeletionEnvelope(data.Value!, meta.Value!, hasErrors.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="WebhookEndpointDeletionEnvelope" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="webhookEndpointDeletionEnvelope"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, WebhookEndpointDeletionEnvelope webhookEndpointDeletionEnvelope, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, webhookEndpointDeletionEnvelope, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="WebhookEndpointDeletionEnvelope" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="webhookEndpointDeletionEnvelope"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, WebhookEndpointDeletionEnvelope webhookEndpointDeletionEnvelope, JsonSerializerOptions jsonSerializerOptions)
        {
            if (webhookEndpointDeletionEnvelope.Data == null)
                throw new ArgumentNullException(nameof(webhookEndpointDeletionEnvelope.Data), "Property is required for class WebhookEndpointDeletionEnvelope.");

            if (webhookEndpointDeletionEnvelope.Meta == null)
                throw new ArgumentNullException(nameof(webhookEndpointDeletionEnvelope.Meta), "Property is required for class WebhookEndpointDeletionEnvelope.");

            writer.WritePropertyName("data");
            JsonSerializer.Serialize(writer, webhookEndpointDeletionEnvelope.Data, jsonSerializerOptions);
            writer.WritePropertyName("meta");
            JsonSerializer.Serialize(writer, webhookEndpointDeletionEnvelope.Meta, jsonSerializerOptions);
            writer.WriteBoolean("hasErrors", webhookEndpointDeletionEnvelope.HasErrors);
        }
    }
}
