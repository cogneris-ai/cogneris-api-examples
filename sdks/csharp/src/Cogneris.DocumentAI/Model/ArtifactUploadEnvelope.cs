...
namespace Cogneris.DocumentAI.Model
{
    ...
    /// </summary>
    public partial class ArtifactUploadEnvelope : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArtifactUploadEnvelope" /> class.
        /// </summary>
        /// <param name="data">data</param>
        /// <param name="meta">meta</param>
        /// <param name="hasErrors">hasErrors</param>
        [JsonConstructor]
        public ArtifactUploadEnvelope(Artifact data, ServiceResponseMeta meta, bool hasErrors)
        {
            Data = data;
            Meta = meta;
            HasErrors = hasErrors;
    ...
    /// <summary>
    /// A Json converter for type <see cref="ArtifactUploadEnvelope" />
    /// </summary>
    public partial class ArtifactUploadEnvelopeJsonConverter : JsonConverter<ArtifactUploadEnvelope>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ArtifactUploadEnvelopeJsonConverter" /> class.
        /// </summary>
        public ArtifactUploadEnvelopeJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="ArtifactUploadEnvelope" />
        /// </summary>
        ...
        public override ArtifactUploadEnvelope Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "data":
                            data = new Option<Artifact?>(JsonSerializer.Deserialize<Artifact>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "meta":
            ...
            if (!data.IsSet)
                throw new ArgumentException("Property is required for class ArtifactUploadEnvelope.", nameof(data));

            if (!meta.IsSet)
                throw new ArgumentException("Property is required for class ArtifactUploadEnvelope.", nameof(meta));

            if (!hasErrors.IsSet)
                throw new ArgumentException("Property is required for class ArtifactUploadEnvelope.", nameof(hasErrors));

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ArtifactUploadEnvelope.");

            if (meta.IsSet && meta.Value == null)
                throw new ArgumentNullException(nameof(meta), "Property is not nullable for class ArtifactUploadEnvelope.");

            if (hasErrors.IsSet && hasErrors.Value == null)
                throw new ArgumentNullException(nameof(hasErrors), "Property is not nullable for class ArtifactUploadEnvelope.");

            return new ArtifactUploadEnvelope(data.Value!, meta.Value!, hasErrors.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="ArtifactUploadEnvelope" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="artifactUploadEnvelope"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ArtifactUploadEnvelope artifactUploadEnvelope, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, artifactUploadEnvelope, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ArtifactUploadEnvelope" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="artifactUploadEnvelope"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ArtifactUploadEnvelope artifactUploadEnvelope, JsonSerializerOptions jsonSerializerOptions)
        {
            if (artifactUploadEnvelope.Data == null)
                throw new ArgumentNullException(nameof(artifactUploadEnvelope.Data), "Property is required for class ArtifactUploadEnvelope.");

            if (artifactUploadEnvelope.Meta == null)
                throw new ArgumentNullException(nameof(artifactUploadEnvelope.Meta), "Property is required for class ArtifactUploadEnvelope.");

            writer.WritePropertyName("data");
            JsonSerializer.Serialize(writer, artifactUploadEnvelope.Data, jsonSerializerOptions);
            writer.WritePropertyName("meta");
            JsonSerializer.Serialize(writer, artifactUploadEnvelope.Meta, jsonSerializerOptions);
            writer.WriteBoolean("hasErrors", artifactUploadEnvelope.HasErrors);
        }
    }
}
