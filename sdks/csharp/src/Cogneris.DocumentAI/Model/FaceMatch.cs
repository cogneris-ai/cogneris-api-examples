...
namespace Cogneris.DocumentAI.Model
{
    ...
    /// FaceMatch
    /// </summary>
    public partial class FaceMatch : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FaceMatch" /> class.
        /// </summary>
        /// <param name="sourceDocumentId">sourceDocumentId</param>
        /// <param name="selfieDocumentId">selfieDocumentId</param>
        /// <param name="score">Similarity between the selfie and the document face.</param>
        /// <param name="matched">matched</param>
        /// <param name="tooManyFaces">tooManyFaces</param>
        [JsonConstructor]
        public FaceMatch(Option<Guid?> sourceDocumentId = default, Option<Guid?> selfieDocumentId = default, Option<decimal?> score = default, Option<bool?> matched = default, Option<bool?> tooManyFaces = default)
        {
            SourceDocumentIdOption = sourceDocumentId;
            SelfieDocumentIdOption = selfieDocumentId;
            ScoreOption = score;
            MatchedOption = matched;
            TooManyFacesOption = tooManyFaces;
            OnCreated();
        }
        ...
        /// <summary>
        /// Used to track the state of SourceDocumentId
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<Guid?> SourceDocumentIdOption { get; private set; }

        /// <summary>
        /// Gets or Sets SourceDocumentId
        /// </summary>
        [JsonPropertyName("sourceDocumentId")]
        public Guid? SourceDocumentId { get { return this.SourceDocumentIdOption.Value; } set { this.SourceDocumentIdOption = new(value); } }

        /// <summary>
        /// Used to track the state of SelfieDocumentId
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<Guid?> SelfieDocumentIdOption { get; private set; }

        /// <summary>
        /// Gets or Sets SelfieDocumentId
        /// </summary>
        [JsonPropertyName("selfieDocumentId")]
        public Guid? SelfieDocumentId { get { return this.SelfieDocumentIdOption.Value; } set { this.SelfieDocumentIdOption = new(value); } }
        ...
        /// </summary>
        /// <value>Similarity between the selfie and the document face.</value>
        ...
        public bool? Matched { get { return this.MatchedOption.Value; } set { this.MatchedOption = new(value); } }

        /// <summary>
        /// Used to track the state of TooManyFaces
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<bool?> TooManyFacesOption { get; private set; }

        /// <summary>
        /// Gets or Sets TooManyFaces
        /// </summary>
        [JsonPropertyName("tooManyFaces")]
        public bool? TooManyFaces { get { return this.TooManyFacesOption.Value; } set { this.TooManyFacesOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SelfieDocumentId: ").Append(SelfieDocumentId).Append("\n");
            sb.Append("  Score: ").Append(Score).Append("\n");
            sb.Append("  Matched: ").Append(Matched).Append("\n");
            sb.Append("  TooManyFaces: ").Append(TooManyFaces).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="FaceMatch" />
    /// </summary>
    public partial class FaceMatchJsonConverter : JsonConverter<FaceMatch>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="FaceMatchJsonConverter" /> class.
        /// </summary>
        public FaceMatchJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="FaceMatch" />
        /// </summary>
        ...
        public override FaceMatch Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<Guid?> sourceDocumentId = default;
            Option<Guid?> selfieDocumentId = default;
            Option<decimal?> score = default;
            Option<bool?> matched = default;
            Option<bool?> tooManyFaces = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "sourceDocumentId":
                            sourceDocumentId = new Option<Guid?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (Guid?)null : utf8JsonReader.GetGuid());
                            break;
                        case "selfieDocumentId":
                            selfieDocumentId = new Option<Guid?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (Guid?)null : utf8JsonReader.GetGuid());
                            break;
                        case "score":
                        ...
                        case "matched":
                            ...
                            break;
                        case "tooManyFaces":
                            tooManyFaces = new Option<bool?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (bool?)null : utf8JsonReader.GetBoolean());
                            break;
                        default:
                            break;
                    }
            ...
            if (sourceDocumentId.IsSet && sourceDocumentId.Value == null)
                throw new ArgumentNullException(nameof(sourceDocumentId), "Property is not nullable for class FaceMatch.");

            if (selfieDocumentId.IsSet && selfieDocumentId.Value == null)
                throw new ArgumentNullException(nameof(selfieDocumentId), "Property is not nullable for class FaceMatch.");

            if (score.IsSet && score.Value == null)
                throw new ArgumentNullException(nameof(score), "Property is not nullable for class FaceMatch.");

            if (matched.IsSet && matched.Value == null)
                throw new ArgumentNullException(nameof(matched), "Property is not nullable for class FaceMatch.");

            if (tooManyFaces.IsSet && tooManyFaces.Value == null)
                throw new ArgumentNullException(nameof(tooManyFaces), "Property is not nullable for class FaceMatch.");

            return new FaceMatch(sourceDocumentId, selfieDocumentId, score, matched, tooManyFaces);
        }

        /// <summary>
        /// Serializes a <see cref="FaceMatch" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="faceMatch"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, FaceMatch faceMatch, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, faceMatch, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="FaceMatch" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="faceMatch"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, FaceMatch faceMatch, JsonSerializerOptions jsonSerializerOptions)
        {
            if (faceMatch.SourceDocumentIdOption.IsSet)
                writer.WriteString("sourceDocumentId", faceMatch.SourceDocumentIdOption.Value!.Value);

            if (faceMatch.SelfieDocumentIdOption.IsSet)
                writer.WriteString("selfieDocumentId", faceMatch.SelfieDocumentIdOption.Value!.Value);

            if (faceMatch.ScoreOption.IsSet)
                writer.WriteNumber("score", faceMatch.ScoreOption.Value!.Value);

            if (faceMatch.MatchedOption.IsSet)
                writer.WriteBoolean("matched", faceMatch.MatchedOption.Value!.Value);

            if (faceMatch.TooManyFacesOption.IsSet)
                writer.WriteBoolean("tooManyFaces", faceMatch.TooManyFacesOption.Value!.Value);
        }
    }
}
