...
namespace Cogneris.DocumentAI.Model
{
    ...
    public partial class Template : IValidatableObject
    {
        ...
        /// <param name="status">Only finished templates are returned by this endpoint.</param>
        /// <param name="description">description</param>
        [JsonConstructor]
        public Template(Guid id, string name, StatusEnum status, Option<string?> description = default)
        {
            Id = id;
            Name = name;
            Status = status;
        ...
        /// </summary>
        /// <value>Only finished templates are returned by this endpoint.</value>
    ...
    /// </summary>
    public partial class TemplateJsonConverter : JsonConverter<Template>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateJsonConverter" /> class.
        /// </summary>
        public TemplateJsonConverter()
        {
            OnCreated();
        }
        ...
        public override Template Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<Template.StatusEnum?> status = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "status":
                            ...
                            {
                                Template.StatusEnum? statusValue = Template.StatusEnumFromStringOrDefault(statusRawValue);
                                if (statusValue == null)
                                    throw new JsonException();
                                status = new Option<Template.StatusEnum?>(statusValue);
                            }
                            break;
                        case "description":
            ...
            if (!id.IsSet)
                throw new ArgumentException("Property is required for class Template.", nameof(id));

            if (!name.IsSet)
                throw new ArgumentException("Property is required for class Template.", nameof(name));

            if (!status.IsSet)
                throw new ArgumentException("Property is required for class Template.", nameof(status));
            ...
            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class Template.");

            return new Template(id.Value!.Value!, name.Value!, status.Value!.Value!, description);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, Template template, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var statusRawValue = Template.StatusEnumToJsonValue(template.Status);
            writer.WriteString("status", statusRawValue);
            if (template.DescriptionOption.IsSet)
                if (template.DescriptionOption.Value != null)
