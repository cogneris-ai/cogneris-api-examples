...
namespace Cogneris.DocumentAI.Model
{
    ...
    /// </summary>
    public partial class WebhookEndpointDeletion : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEndpointDeletion" /> class.
        /// </summary>
        /// <param name="deleted">deleted</param>
        [JsonConstructor]
        public WebhookEndpointDeletion(bool deleted)
        {
            Deleted = deleted;
            OnCreated();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="WebhookEndpointDeletion" />
    /// </summary>
    public partial class WebhookEndpointDeletionJsonConverter : JsonConverter<WebhookEndpointDeletion>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEndpointDeletionJsonConverter" /> class.
        /// </summary>
        public WebhookEndpointDeletionJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="WebhookEndpointDeletion" />
        /// </summary>
        ...
        public override WebhookEndpointDeletion Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!deleted.IsSet)
                throw new ArgumentException("Property is required for class WebhookEndpointDeletion.", nameof(deleted));

            if (deleted.IsSet && deleted.Value == null)
                throw new ArgumentNullException(nameof(deleted), "Property is not nullable for class WebhookEndpointDeletion.");

            return new WebhookEndpointDeletion(deleted.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="WebhookEndpointDeletion" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="webhookEndpointDeletion"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, WebhookEndpointDeletion webhookEndpointDeletion, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, webhookEndpointDeletion, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="WebhookEndpointDeletion" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="webhookEndpointDeletion"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, WebhookEndpointDeletion webhookEndpointDeletion, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteBoolean("deleted", webhookEndpointDeletion.Deleted);
        }
    }
}
