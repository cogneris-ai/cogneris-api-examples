...
namespace Cogneris.DocumentAI.Model
{
    ...
    /// </summary>
    public partial class WebhookEndpointCreatedEnvelope : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEndpointCreatedEnvelope" /> class.
        /// </summary>
        /// <param name="data">data</param>
        /// <param name="meta">meta</param>
        /// <param name="hasErrors">hasErrors</param>
        [JsonConstructor]
        public WebhookEndpointCreatedEnvelope(WebhookEndpointCreated data, ServiceResponseMeta meta, bool hasErrors)
        {
            Data = data;
            Meta = meta;
            HasErrors = hasErrors;
        ...
        public WebhookEndpointCreated Data { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="WebhookEndpointCreatedEnvelope" />
    /// </summary>
    public partial class WebhookEndpointCreatedEnvelopeJsonConverter : JsonConverter<WebhookEndpointCreatedEnvelope>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEndpointCreatedEnvelopeJsonConverter" /> class.
        /// </summary>
        public WebhookEndpointCreatedEnvelopeJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="WebhookEndpointCreatedEnvelope" />
        /// </summary>
        ...
        public override WebhookEndpointCreatedEnvelope Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<WebhookEndpointCreated?> data = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "data":
                            data = new Option<WebhookEndpointCreated?>(JsonSerializer.Deserialize<WebhookEndpointCreated>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "meta":
            ...
            if (!data.IsSet)
                throw new ArgumentException("Property is required for class WebhookEndpointCreatedEnvelope.", nameof(data));

            if (!meta.IsSet)
                throw new ArgumentException("Property is required for class WebhookEndpointCreatedEnvelope.", nameof(meta));

            if (!hasErrors.IsSet)
                throw new ArgumentException("Property is required for class WebhookEndpointCreatedEnvelope.", nameof(hasErrors));

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class WebhookEndpointCreatedEnvelope.");

            if (meta.IsSet && meta.Value == null)
                throw new ArgumentNullException(nameof(meta), "Property is not nullable for class WebhookEndpointCreatedEnvelope.");

            if (hasErrors.IsSet && hasErrors.Value == null)
                throw new ArgumentNullException(nameof(hasErrors), "Property is not nullable for class WebhookEndpointCreatedEnvelope.");

            return new WebhookEndpointCreatedEnvelope(data.Value!, meta.Value!, hasErrors.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="WebhookEndpointCreatedEnvelope" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="webhookEndpointCreatedEnvelope"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, WebhookEndpointCreatedEnvelope webhookEndpointCreatedEnvelope, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, webhookEndpointCreatedEnvelope, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="WebhookEndpointCreatedEnvelope" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="webhookEndpointCreatedEnvelope"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, WebhookEndpointCreatedEnvelope webhookEndpointCreatedEnvelope, JsonSerializerOptions jsonSerializerOptions)
        {
            if (webhookEndpointCreatedEnvelope.Data == null)
                throw new ArgumentNullException(nameof(webhookEndpointCreatedEnvelope.Data), "Property is required for class WebhookEndpointCreatedEnvelope.");

            if (webhookEndpointCreatedEnvelope.Meta == null)
                throw new ArgumentNullException(nameof(webhookEndpointCreatedEnvelope.Meta), "Property is required for class WebhookEndpointCreatedEnvelope.");

            writer.WritePropertyName("data");
            JsonSerializer.Serialize(writer, webhookEndpointCreatedEnvelope.Data, jsonSerializerOptions);
            writer.WritePropertyName("meta");
            JsonSerializer.Serialize(writer, webhookEndpointCreatedEnvelope.Meta, jsonSerializerOptions);
            writer.WriteBoolean("hasErrors", webhookEndpointCreatedEnvelope.HasErrors);
        }
    }
}
