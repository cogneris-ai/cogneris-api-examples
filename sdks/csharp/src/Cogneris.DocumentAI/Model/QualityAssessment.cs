...
namespace Cogneris.DocumentAI.Model
{
    ...
    /// QualityAssessment
    /// </summary>
    public partial class QualityAssessment : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QualityAssessment" /> class.
        /// </summary>
        /// <param name="overall">The worst level across &#x60;findings&#x60;; &#x60;0&#x60; when there are none.</param>
        /// <param name="findings">Each probe that did not pass. Passing probes are left out.</param>
        [JsonConstructor]
        public QualityAssessment(QualityVerdict overall, List<QualityFinding> findings)
        {
            Overall = overall;
            Findings = findings;
            OnCreated();
        ...
        /// </summary>
        /// <value>The worst level across &#x60;findings&#x60;; &#x60;0&#x60; when there are none.</value>
        [JsonPropertyName("overall")]
        public QualityVerdict Overall { get; set; }

        /// <summary>
        /// Each probe that did not pass. Passing probes are left out.
        /// </summary>
        /// <value>Each probe that did not pass. Passing probes are left out.</value>
        [JsonPropertyName("findings")]
        public List<QualityFinding> Findings { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="QualityAssessment" />
    /// </summary>
    public partial class QualityAssessmentJsonConverter : JsonConverter<QualityAssessment>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="QualityAssessmentJsonConverter" /> class.
        /// </summary>
        public QualityAssessmentJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="QualityAssessment" />
        /// </summary>
        ...
        public override QualityAssessment Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<QualityVerdict?> overall = default;
            Option<List<QualityFinding>?> findings = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "overall":
                            overall = new Option<QualityVerdict?>(JsonSerializer.Deserialize<QualityVerdict?>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "findings":
                            findings = new Option<List<QualityFinding>?>(JsonSerializer.Deserialize<List<QualityFinding>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (!overall.IsSet)
                throw new ArgumentException("Property is required for class QualityAssessment.", nameof(overall));

            if (!findings.IsSet)
                throw new ArgumentException("Property is required for class QualityAssessment.", nameof(findings));

            if (overall.IsSet && overall.Value == null)
                throw new ArgumentNullException(nameof(overall), "Property is not nullable for class QualityAssessment.");

            if (findings.IsSet && findings.Value == null)
                throw new ArgumentNullException(nameof(findings), "Property is not nullable for class QualityAssessment.");

            return new QualityAssessment(overall.Value!.Value!, findings.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="QualityAssessment" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="qualityAssessment"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, QualityAssessment qualityAssessment, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, qualityAssessment, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="QualityAssessment" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="qualityAssessment"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, QualityAssessment qualityAssessment, JsonSerializerOptions jsonSerializerOptions)
        {
            if (qualityAssessment.Findings == null)
                throw new ArgumentNullException(nameof(qualityAssessment.Findings), "Property is required for class QualityAssessment.");

            writer.WriteNumber("overall", QualityVerdictValueConverter.ToJsonValue(qualityAssessment.Overall));

            writer.WritePropertyName("findings");
            JsonSerializer.Serialize(writer, qualityAssessment.Findings, jsonSerializerOptions);
        }
    }
}
