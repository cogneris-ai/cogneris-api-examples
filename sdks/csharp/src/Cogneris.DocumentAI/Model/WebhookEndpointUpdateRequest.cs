...
namespace Cogneris.DocumentAI.Model
{
    ...
    /// </summary>
    public partial class WebhookEndpointUpdateRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEndpointUpdateRequest" /> class.
        /// </summary>
        /// <param name="name">name</param>
        /// <param name="url">Changing it rotates the signing secret.</param>
        /// <param name="events">events</param>
        /// <param name="id">Ignored. The endpoint is the one named in the path.</param>
        /// <param name="headers">headers</param>
        /// <param name="body">body</param>
        /// <param name="isActive">An inactive endpoint is kept but receives nothing. (default to true)</param>
        [JsonConstructor]
        public WebhookEndpointUpdateRequest(string name, string url, List<WebhookEvent> events, Option<Guid?> id = default, Option<Dictionary<string, string>?> headers = default, Option<string?> body = default, Option<bool?> isActive = default)
        {
            Name = name;
            Url = url;
            Events = events;
        ...
        /// </summary>
        /// <value>Changing it rotates the signing secret.</value>
        ...
        /// </summary>
        /// <value>Ignored. The endpoint is the one named in the path.</value>
        [JsonPropertyName("id")]
        ...
        /// </summary>
        /// <value>An inactive endpoint is kept but receives nothing.</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="WebhookEndpointUpdateRequest" />
    /// </summary>
    public partial class WebhookEndpointUpdateRequestJsonConverter : JsonConverter<WebhookEndpointUpdateRequest>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEndpointUpdateRequestJsonConverter" /> class.
        /// </summary>
        public WebhookEndpointUpdateRequestJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="WebhookEndpointUpdateRequest" />
        /// </summary>
        ...
        public override WebhookEndpointUpdateRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!name.IsSet)
                throw new ArgumentException("Property is required for class WebhookEndpointUpdateRequest.", nameof(name));

            if (!url.IsSet)
                throw new ArgumentException("Property is required for class WebhookEndpointUpdateRequest.", nameof(url));

            if (!events.IsSet)
                throw new ArgumentException("Property is required for class WebhookEndpointUpdateRequest.", nameof(events));

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class WebhookEndpointUpdateRequest.");

            if (url.IsSet && url.Value == null)
                throw new ArgumentNullException(nameof(url), "Property is not nullable for class WebhookEndpointUpdateRequest.");

            if (events.IsSet && events.Value == null)
                throw new ArgumentNullException(nameof(events), "Property is not nullable for class WebhookEndpointUpdateRequest.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class WebhookEndpointUpdateRequest.");

            if (isActive.IsSet && isActive.Value == null)
                throw new ArgumentNullException(nameof(isActive), "Property is not nullable for class WebhookEndpointUpdateRequest.");

            return new WebhookEndpointUpdateRequest(name.Value!, url.Value!, events.Value!, id, headers, body, isActive);
        }

        /// <summary>
        /// Serializes a <see cref="WebhookEndpointUpdateRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="webhookEndpointUpdateRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, WebhookEndpointUpdateRequest webhookEndpointUpdateRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, webhookEndpointUpdateRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="WebhookEndpointUpdateRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="webhookEndpointUpdateRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, WebhookEndpointUpdateRequest webhookEndpointUpdateRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (webhookEndpointUpdateRequest.Name == null)
                throw new ArgumentNullException(nameof(webhookEndpointUpdateRequest.Name), "Property is required for class WebhookEndpointUpdateRequest.");

            if (webhookEndpointUpdateRequest.Url == null)
                throw new ArgumentNullException(nameof(webhookEndpointUpdateRequest.Url), "Property is required for class WebhookEndpointUpdateRequest.");

            if (webhookEndpointUpdateRequest.Events == null)
                throw new ArgumentNullException(nameof(webhookEndpointUpdateRequest.Events), "Property is required for class WebhookEndpointUpdateRequest.");

            writer.WriteString("name", webhookEndpointUpdateRequest.Name);

            writer.WriteString("url", webhookEndpointUpdateRequest.Url);

            writer.WritePropertyName("events");
            JsonSerializer.Serialize(writer, webhookEndpointUpdateRequest.Events, jsonSerializerOptions);
            if (webhookEndpointUpdateRequest.IdOption.IsSet)
                writer.WriteString("id", webhookEndpointUpdateRequest.IdOption.Value!.Value);

            if (webhookEndpointUpdateRequest.HeadersOption.IsSet)
                if (webhookEndpointUpdateRequest.HeadersOption.Value != null)
                {
                    writer.WritePropertyName("headers");
                    JsonSerializer.Serialize(writer, webhookEndpointUpdateRequest.Headers, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("headers");
            if (webhookEndpointUpdateRequest.BodyOption.IsSet)
                if (webhookEndpointUpdateRequest.BodyOption.Value != null)
                    writer.WriteString("body", webhookEndpointUpdateRequest.Body);
                else
                    writer.WriteNull("body");

            if (webhookEndpointUpdateRequest.IsActiveOption.IsSet)
                writer.WriteBoolean("isActive", webhookEndpointUpdateRequest.IsActiveOption.Value!.Value);
        }
    }
}
