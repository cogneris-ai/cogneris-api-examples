...
namespace Cogneris.DocumentAI.Model
{
    ...
    /// WebhookEndpointList
    /// </summary>
    public partial class WebhookEndpointList : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEndpointList" /> class.
        /// </summary>
        /// <param name="endpoints">endpoints</param>
        [JsonConstructor]
        public WebhookEndpointList(List<WebhookEndpoint> endpoints)
        {
            Endpoints = endpoints;
            OnCreated();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="WebhookEndpointList" />
    /// </summary>
    public partial class WebhookEndpointListJsonConverter : JsonConverter<WebhookEndpointList>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEndpointListJsonConverter" /> class.
        /// </summary>
        public WebhookEndpointListJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="WebhookEndpointList" />
        /// </summary>
        ...
        public override WebhookEndpointList Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<WebhookEndpoint>?> endpoints = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "endpoints":
                            endpoints = new Option<List<WebhookEndpoint>?>(JsonSerializer.Deserialize<List<WebhookEndpoint>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (!endpoints.IsSet)
                throw new ArgumentException("Property is required for class WebhookEndpointList.", nameof(endpoints));

            if (endpoints.IsSet && endpoints.Value == null)
                throw new ArgumentNullException(nameof(endpoints), "Property is not nullable for class WebhookEndpointList.");

            return new WebhookEndpointList(endpoints.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="WebhookEndpointList" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="webhookEndpointList"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, WebhookEndpointList webhookEndpointList, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, webhookEndpointList, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="WebhookEndpointList" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="webhookEndpointList"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, WebhookEndpointList webhookEndpointList, JsonSerializerOptions jsonSerializerOptions)
        {
            if (webhookEndpointList.Endpoints == null)
                throw new ArgumentNullException(nameof(webhookEndpointList.Endpoints), "Property is required for class WebhookEndpointList.");

            writer.WritePropertyName("endpoints");
            JsonSerializer.Serialize(writer, webhookEndpointList.Endpoints, jsonSerializerOptions);
        }
    }
}
