...
namespace Cogneris.DocumentAI.Model
{
    ...
    /// </summary>
    public partial class TemplateListEnvelope : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateListEnvelope" /> class.
        /// </summary>
        /// <param name="data">data</param>
        /// <param name="meta">meta</param>
        /// <param name="hasErrors">hasErrors</param>
        [JsonConstructor]
        public TemplateListEnvelope(TemplateList data, ServiceResponseMeta meta, bool hasErrors)
        {
            Data = data;
            Meta = meta;
            HasErrors = hasErrors;
        ...
        public TemplateList Data { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="TemplateListEnvelope" />
    /// </summary>
    public partial class TemplateListEnvelopeJsonConverter : JsonConverter<TemplateListEnvelope>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateListEnvelopeJsonConverter" /> class.
        /// </summary>
        public TemplateListEnvelopeJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="TemplateListEnvelope" />
        /// </summary>
        ...
        public override TemplateListEnvelope Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<TemplateList?> data = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "data":
                            data = new Option<TemplateList?>(JsonSerializer.Deserialize<TemplateList>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "meta":
            ...
            if (!data.IsSet)
                throw new ArgumentException("Property is required for class TemplateListEnvelope.", nameof(data));

            if (!meta.IsSet)
                throw new ArgumentException("Property is required for class TemplateListEnvelope.", nameof(meta));

            if (!hasErrors.IsSet)
                throw new ArgumentException("Property is required for class TemplateListEnvelope.", nameof(hasErrors));

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class TemplateListEnvelope.");

            if (meta.IsSet && meta.Value == null)
                throw new ArgumentNullException(nameof(meta), "Property is not nullable for class TemplateListEnvelope.");

            if (hasErrors.IsSet && hasErrors.Value == null)
                throw new ArgumentNullException(nameof(hasErrors), "Property is not nullable for class TemplateListEnvelope.");

            return new TemplateListEnvelope(data.Value!, meta.Value!, hasErrors.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="TemplateListEnvelope" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="templateListEnvelope"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TemplateListEnvelope templateListEnvelope, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, templateListEnvelope, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TemplateListEnvelope" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="templateListEnvelope"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TemplateListEnvelope templateListEnvelope, JsonSerializerOptions jsonSerializerOptions)
        {
            if (templateListEnvelope.Data == null)
                throw new ArgumentNullException(nameof(templateListEnvelope.Data), "Property is required for class TemplateListEnvelope.");

            if (templateListEnvelope.Meta == null)
                throw new ArgumentNullException(nameof(templateListEnvelope.Meta), "Property is required for class TemplateListEnvelope.");

            writer.WritePropertyName("data");
            JsonSerializer.Serialize(writer, templateListEnvelope.Data, jsonSerializerOptions);
            writer.WritePropertyName("meta");
            JsonSerializer.Serialize(writer, templateListEnvelope.Meta, jsonSerializerOptions);
            writer.WriteBoolean("hasErrors", templateListEnvelope.HasErrors);
        }
    }
}
