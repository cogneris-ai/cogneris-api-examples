...
namespace Cogneris.DocumentAI.Model
{
    ...
    public partial class ProblemDetailsErrorsInner : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ProblemDetailsErrorsInner(Option<string?> code = default, Option<string?> message = default, Option<string?> field = default, Option<bool?> retryable = default, Option<Dictionary<string, string>?> details = default)
        {
            CodeOption = code;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<Dictionary<string, string>?> DetailsOption { get; private set; }

        /// <summary>
        /// Gets or Sets Details
        /// </summary>
        [JsonPropertyName("details")]
        public Dictionary<string, string>? Details { get { return this.DetailsOption.Value; } set { this.DetailsOption = new(value); } }
    ...
    public partial class ProblemDetailsErrorsInnerJsonConverter : JsonConverter<ProblemDetailsErrorsInner>
    {
        ...
        public override ProblemDetailsErrorsInner Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<Dictionary<string, string>?> details = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "retryable":
                            ...
                            break;
                        case "details":
                            details = new Option<Dictionary<string, string>?>(JsonSerializer.Deserialize<Dictionary<string, string>>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        default:
                            break;
                    }
            ...
            return new ProblemDetailsErrorsInner(code, message, field, retryable, details);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, ProblemDetailsErrorsInner problemDetailsErrorsInner, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (problemDetailsErrorsInner.FieldOption.IsSet)
                if (problemDetailsErrorsInner.FieldOption.Value != null)
            ...
            if (problemDetailsErrorsInner.DetailsOption.IsSet)
                if (problemDetailsErrorsInner.DetailsOption.Value != null)
                {
                    writer.WritePropertyName("details");
                    JsonSerializer.Serialize(writer, problemDetailsErrorsInner.Details, jsonSerializerOptions);
                }
                else
