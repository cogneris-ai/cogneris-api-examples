...
namespace Cogneris.DocumentAI.Model
{
    ...
    public partial class ProblemDetails : IValidatableObject
    {
        ...
        /// <param name="field">The request field at fault, on validation failures.</param>
        /// <param name="errors">errors</param>
        [JsonConstructor]
        public ProblemDetails(Option<string?> type = default, Option<string?> title = default, Option<int?> status = default, Option<string?> detail = default, Option<string?> instance = default, Option<string?> code = default, Option<string?> correlationId = default, Option<bool?> retryable = default, Option<string?> field = default, Option<List<ProblemDetailsErrorsInner>?> errors = default)
        {
            TypeOption = type;
            TitleOption = title;
            StatusOption = status;
        ...
        /// </summary>
        /// <value>The request field at fault, on validation failures.</value>
    ...
    public partial class ProblemDetailsJsonConverter : JsonConverter<ProblemDetails>
    {
        ...
        public override ProblemDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new ProblemDetails(type, title, status, detail, instance, code, correlationId, retryable, field, errors);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, ProblemDetails problemDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (problemDetails.FieldOption.IsSet)
                if (problemDetails.FieldOption.Value != null)
                    writer.WriteString("field", problemDetails.Field);
                else
