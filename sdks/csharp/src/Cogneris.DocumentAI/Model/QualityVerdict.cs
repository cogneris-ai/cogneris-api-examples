...
namespace Cogneris.DocumentAI.Model
{
    ...
    /// </summary>
    /// <value>&#x60;0&#x60; pass, &#x60;1&#x60; warn, &#x60;2&#x60; block. Sent as the number, not the name.</value>
    ...
    /// <summary>
    /// Converts <see cref="QualityVerdict"/> to and from the JSON value
    /// </summary>
    public static class QualityVerdictValueConverter
    {
        /// <summary>
        /// Parses a given value to <see cref="QualityVerdict"/>
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        public static QualityVerdict FromString(string value)
        {
            if (value.Equals((0).ToString(System.Globalization.CultureInfo.InvariantCulture)))
                return QualityVerdict.NUMBER_0;

            if (value.Equals((1).ToString(System.Globalization.CultureInfo.InvariantCulture)))
                return QualityVerdict.NUMBER_1;

            if (value.Equals((2).ToString(System.Globalization.CultureInfo.InvariantCulture)))
                return QualityVerdict.NUMBER_2;

            throw new NotImplementedException($"Could not convert value to type QualityVerdict: '{value}'");
        }
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static QualityVerdict? FromStringOrDefault(string value)
        {
            if (value.Equals((0).ToString(System.Globalization.CultureInfo.InvariantCulture)))
                return QualityVerdict.NUMBER_0;
        ...
        /// <summary>
        /// Converts the <see cref="QualityVerdict"/> to the json value
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        /// <exception cref="NotImplementedException"></exception>
        public static int ToJsonValue(QualityVerdict value)
        {
            return (int) value;
        }
    }
    ...
    /// <summary>
    /// A Json converter for type <see cref="QualityVerdict"/>
    /// </summary>
    /// <exception cref="NotImplementedException"></exception>
    public class QualityVerdictJsonConverter : JsonConverter<QualityVerdict>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override QualityVerdict Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            string rawValue = reader.GetInt32().ToString(System.Globalization.CultureInfo.InvariantCulture);
            QualityVerdict? result = QualityVerdictValueConverter.FromStringOrDefault(rawValue);
            if (result != null)
                return result.Value;
        ...
        /// <summary>
        /// Writes the QualityVerdict to the json writer
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="qualityVerdict"></param>
        /// <param name="options"></param>
        public override void Write(Utf8JsonWriter writer, QualityVerdict qualityVerdict, JsonSerializerOptions options)
        {
            writer.WriteNumberValue(QualityVerdictValueConverter.ToJsonValue(qualityVerdict));
        }
    }
    ...
    /// A Json converter for type <see cref="QualityVerdict"/>
    /// </summary>
    public class QualityVerdictNullableJsonConverter : JsonConverter<QualityVerdict?>
    {
        /// <summary>
        /// Returns a QualityVerdict from the Json object
        /// </summary>
        /// <param name="reader"></param>
        /// <param name="typeToConvert"></param>
        /// <param name="options"></param>
        ...
        public override void Write(Utf8JsonWriter writer, QualityVerdict? qualityVerdict, JsonSerializerOptions options)
        {
            if (qualityVerdict.HasValue)
                writer.WriteNumberValue(QualityVerdictValueConverter.ToJsonValue(qualityVerdict.Value));
            else
