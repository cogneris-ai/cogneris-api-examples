...
namespace Cogneris.DocumentAI.Model
{
    ...
    /// FaceExtraction
    /// </summary>
    public partial class FaceExtraction : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FaceExtraction" /> class.
        /// </summary>
        /// <param name="sourceDocumentId">sourceDocumentId</param>
        /// <param name="hasFace">hasFace</param>
        /// <param name="documentType">documentType</param>
        /// <param name="cropSignedUrl">Signed URL of the face crop. Null when none was produced.</param>
        [JsonConstructor]
        public FaceExtraction(Option<Guid?> sourceDocumentId = default, Option<bool?> hasFace = default, Option<string?> documentType = default, Option<string?> cropSignedUrl = default)
        {
            SourceDocumentIdOption = sourceDocumentId;
            HasFaceOption = hasFace;
            DocumentTypeOption = documentType;
            CropSignedUrlOption = cropSignedUrl;
            OnCreated();
        }
        ...
        /// <summary>
        /// Used to track the state of HasFace
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<bool?> HasFaceOption { get; private set; }

        /// <summary>
        /// Gets or Sets HasFace
        /// </summary>
        [JsonPropertyName("hasFace")]
        public bool? HasFace { get { return this.HasFaceOption.Value; } set { this.HasFaceOption = new(value); } }
        ...
        /// <summary>
        /// Used to track the state of CropSignedUrl
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<string?> CropSignedUrlOption { get; private set; }

        /// <summary>
        /// Signed URL of the face crop. Null when none was produced.
        /// </summary>
        /// <value>Signed URL of the face crop. Null when none was produced.</value>
        [JsonPropertyName("cropSignedUrl")]
        public string? CropSignedUrl { get { return this.CropSignedUrlOption.Value; } set { this.CropSignedUrlOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  HasFace: ").Append(HasFace).Append("\n");
            sb.Append("  DocumentType: ").Append(DocumentType).Append("\n");
            sb.Append("  CropSignedUrl: ").Append(CropSignedUrl).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="FaceExtraction" />
    /// </summary>
    public partial class FaceExtractionJsonConverter : JsonConverter<FaceExtraction>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="FaceExtractionJsonConverter" /> class.
        /// </summary>
        public FaceExtractionJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="FaceExtraction" />
        /// </summary>
        ...
        public override FaceExtraction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<bool?> hasFace = default;
            Option<string?> documentType = default;
            Option<string?> cropSignedUrl = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "sourceDocumentId":
                            ...
                            break;
                        case "hasFace":
                            hasFace = new Option<bool?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (bool?)null : utf8JsonReader.GetBoolean());
                            break;
                        case "documentType":
                            documentType = new Option<string?>(utf8JsonReader.GetString()!);
                            break;
                        case "cropSignedUrl":
                            cropSignedUrl = new Option<string?>(utf8JsonReader.GetString());
                            break;
                        default:
                            break;
                    }
            ...
            if (sourceDocumentId.IsSet && sourceDocumentId.Value == null)
                throw new ArgumentNullException(nameof(sourceDocumentId), "Property is not nullable for class FaceExtraction.");

            if (hasFace.IsSet && hasFace.Value == null)
                throw new ArgumentNullException(nameof(hasFace), "Property is not nullable for class FaceExtraction.");

            if (documentType.IsSet && documentType.Value == null)
                throw new ArgumentNullException(nameof(documentType), "Property is not nullable for class FaceExtraction.");

            return new FaceExtraction(sourceDocumentId, hasFace, documentType, cropSignedUrl);
        }

        /// <summary>
        /// Serializes a <see cref="FaceExtraction" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="faceExtraction"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, FaceExtraction faceExtraction, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, faceExtraction, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="FaceExtraction" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="faceExtraction"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, FaceExtraction faceExtraction, JsonSerializerOptions jsonSerializerOptions)
        {
            if (faceExtraction.DocumentTypeOption.IsSet && faceExtraction.DocumentType == null)
                throw new ArgumentNullException(nameof(faceExtraction.DocumentType), "Property is required for class FaceExtraction.");

            if (faceExtraction.SourceDocumentIdOption.IsSet)
                writer.WriteString("sourceDocumentId", faceExtraction.SourceDocumentIdOption.Value!.Value);

            if (faceExtraction.HasFaceOption.IsSet)
                writer.WriteBoolean("hasFace", faceExtraction.HasFaceOption.Value!.Value);

            if (faceExtraction.DocumentTypeOption.IsSet)
                writer.WriteString("documentType", faceExtraction.DocumentType);

            if (faceExtraction.CropSignedUrlOption.IsSet)
                if (faceExtraction.CropSignedUrlOption.Value != null)
                    writer.WriteString("cropSignedUrl", faceExtraction.CropSignedUrl);
                else
                    writer.WriteNull("cropSignedUrl");
        }
    }
}
