...
namespace Cogneris.DocumentAI.Model
{
    ...
    public partial class SubmitDocumentJobRequest : IValidatableObject
    {
        ...
        /// <param name="templateId">Extraction only: the id of one of your tenant&#39;s finished templates, whose schema drives the extraction. Omit it and the platform picks the template from the document, as the synchronous endpoint does. Sent with any other operation, the job is refused with &#x60;400&#x60;. An id the platform cannot resolve to a finished template of yours is refused too; the job never falls back to a generic extraction without the schema you asked for. </param>
        [JsonConstructor]
        ...
        /// </summary>
        /// <value>Extraction only: the id of one of your tenant&#39;s finished templates, whose schema drives the extraction. Omit it and the platform picks the template from the document, as the synchronous endpoint does. Sent with any other operation, the job is refused with &#x60;400&#x60;. An id the platform cannot resolve to a finished template of yours is refused too; the job never falls back to a generic extraction without the schema you asked for. </value>
    ...
    public partial class SubmitDocumentJobRequestJsonConverter : JsonConverter<SubmitDocumentJobRequest>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, SubmitDocumentJobRequest submitDocumentJobRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (submitDocumentJobRequest.TemplateIdOption.IsSet)
                if (submitDocumentJobRequest.TemplateIdOption.Value != null)
